  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">VOX AC30買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "VOX AC30の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "現行のCustom（中国製）で3万〜7万円、Hand-Wired（英国製）で7万〜15万円、1960〜70年代のヴィンテージは15万〜50万円以上が目安です。" } },
      { "@type": "Question", name: "真空管アンプは動作しないと売れませんか？", acceptedAnswer: { "@type": "Answer", text: "動作品が高評価ですが、不動でも部品取り・修理前提で買取される場合があります。状態を正直に伝えましょう。" } },
      { "@type": "Question", name: "Celestionスピーカーは価値がありますか？", acceptedAnswer: { "@type": "Answer", text: "はい。Alnico Blue等のオリジナルスピーカーは価値が高く、評価を押し上げます。" } },
      { "@type": "Question", name: "重いので出張買取できますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。掲載3社のうちウリエルは出張買取に対応しており、大型アンプの搬出も依頼できます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】VOX AC30買取相場｜年代・仕様別の価値と真空管アンプの査定ポイント", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】VOX AC30買取相場｜年代・仕様別の価値と真空管アンプの査定ポイント", item: "https://gakkikaitori-biyori.com/articles/vox-ac30-kaitori/" },
  ] };
  return (<>
...
export default function VoxAc30KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">VOX AC30買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】VOX AC30買取相場｜年代・仕様別の価値と真空管アンプの査定ポイント</h1>
          <p className="text-warm-gray text-sm leading-relaxed">VOX AC30を売りたい方へ。きらびやかなブリティッシュトーンで、ビートルズ以降のロックに欠かせない真空管アンプの名機です。本記事ではヴィンテージと現行（Custom/Hand-Wired等）の違い、年代別の価値、真空管やスピーカー（Celestion）の状態が査定に与える影響を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>VOX AC30の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、現行Customで3万〜7万円、Hand-Wiredで7万〜15万円、1960〜70年代ヴィンテージは15万〜50万円以上とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>VOX AC30を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>年代・仕様（ヴィンテージや英国製ハンドワイヤードは高評価）</li>
            <li>真空管・スピーカー（Celestion Alnico Blue等）の状態</li>
            <li>動作確認（ノイズ・ガリ・通電の安定）</li>
            <li>オリジナルパーツ・トランスの保持、改造の有無</li>
          ...
          <p>VOX AC30の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">VOX AC30買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">VOX AC30の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">現行のCustom（中国製）で3万〜7万円、Hand-Wired（英国製）で7万〜15万円、1960〜70年代のヴィンテージは15万〜50万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">真空管アンプは動作しないと売れませんか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">動作品が高評価ですが、不動でも部品取り・修理前提で買取される場合があります。状態を正直に伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Celestionスピーカーは価値がありますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。Alnico Blue等のオリジナルスピーカーは価値が高く、評価を押し上げます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">重いので出張買取できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能です。掲載3社のうちウリエルは出張買取に対応しており、大型アンプの搬出も依頼できます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
