  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Mapex買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Mapexの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "入門セットで1万〜4万円、Saturn等の上位は5万〜15万円が目安です。" } },
      { "@type": "Question", name: "セットで売ると有利ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。総額が伸びます。" } },
      { "@type": "Question", name: "スネア単体でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。人気モデルは需要があります。" } },
      { "@type": "Question", name: "ハードウェアも対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。スタンド類も合わせて査定されます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Mapexドラム買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-07-07", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Mapexドラム買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/mapex-kaitori/" },
  ] };
  return (<>
...
export default function MapexKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Mapex買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Mapexドラム買取おすすめ3社比較｜相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Mapex（メイペックス）のドラムを売りたい方へ。Saturn・Armory・Mars などシリーズ別の価値、セット構成、状態による査定差を解説します。コストパフォーマンスの高さで人気のブランドです。</p>
        ...
        <div className="article-body">
          ...
          <p>Mapexの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、入門セットで1万〜4万円、Saturn等上位は5万〜15万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Mapexを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（Saturn＞Armory＞Mars等）</li>
            <li>セット構成・シェル材</li>
            <li>ラグ・フープ等金属パーツの状態</li>
            <li>フィニッシュ・打痕の状態</li>
            <li>ハードウェア・付属品の有無</li>
          </ul>
          ...
          <p>Mapexの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">Mapex買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Mapexの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">入門セットで1万〜4万円、Saturn等の上位は5万〜15万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
            ...
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">スネア単体でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能です。人気モデルは需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ハードウェアも対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。スタンド類も合わせて査定されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="mapex-kaitori" relatedSlugs={["drum-kaitori", "pearl-kaitori", "tama-kaitori", "dw-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
