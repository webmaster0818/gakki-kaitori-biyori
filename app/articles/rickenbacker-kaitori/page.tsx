  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">リッケンバッカー買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "リッケンバッカーの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "モデル・年式により幅がありますが、現行品で8万〜20万円、ヴィンテージは20万〜数十万円が目安です。" } },
      { "@type": "Question", name: "4003ベースは高く売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。ロック系で根強い人気があり高評価です。" } },
      { "@type": "Question", name: "色（カラー）で価値は変わりますか？", acceptedAnswer: { "@type": "Answer", text: "定番カラーは需要が安定しています。希少色はプレミアが付くことも。" } },
      { "@type": "Question", name: "古い個体でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "ヴィンテージは状態次第で高額になります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】リッケンバッカー買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】リッケンバッカー買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/rickenbacker-kaitori/" },
  ] };
  return (<>
...
export default function RickenbackerKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">リッケンバッカー買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】リッケンバッカー買取おすすめ3社比較｜相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">リッケンバッカー（Rickenbacker）を売りたい方へ。330・360のギター、4001/4003のベースなど人気モデルの価値、年式・カラー・状態による査定差を解説します。独特のサウンドで根強い人気のあるブランドです。</p>
        ...
        <div className="article-body">
          ...
          <div className="bg-warm-bg border border-warm-border rounded-xl p-5 my-6">
            ...
            <ul className="space-y-1 text-sm list-disc pl-5">
              <li><a href="/articles/rickenbacker-330-kaitori/" className="text-accent-dark underline">リッケンバッカー 330買取相場</a></li>
              <li><a href="/articles/rickenbacker-4003-kaitori/" className="text-accent-dark underline">リッケンバッカー 4003の買取相場</a></li>
            </ul>
          </div>


          <h2 id="souba">買取相場の目安</h2>
          <p>リッケンバッカーの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、現行品で8万〜20万円、ヴィンテージは20万〜数十万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>リッケンバッカーを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>モデル（330・360・4003等の人気機）</li>
            <li>年式・カラー（Fireglo・Mapleglo・Jetglo等）</li>
            <li>フレット・電装・バインディングの状態</li>
            <li>左利き/特殊仕様か</li>
            <li>純正ケース・付属品の有無</li>
          </ul>
          ...
          <p>リッケンバッカーの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">リッケンバッカー買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">リッケンバッカーの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">モデル・年式により幅がありますが、現行品で8万〜20万円、ヴィンテージは20万〜数十万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">4003ベースは高く売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。ロック系で根強い人気があり高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">色（カラー）で価値は変わりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">定番カラーは需要が安定しています。希少色はプレミアが付くことも。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古い個体でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ヴィンテージは状態次第で高額になります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="rickenbacker-kaitori" relatedSlugs={["guitar-kaitori", "bass-kaitori", "fender-kaitori", "gibson-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
