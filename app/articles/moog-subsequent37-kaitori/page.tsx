...
export const metadata: Metadata = {
  title: "モーグ サブスィークエント37の買取相場｜今週の実勢中央値・高く売るコツ【2026年8月最新】",
...
function Schema() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"モーグ サブスィークエント37の買取相場はいくらですか？\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"モーグ サブスィークエント37の買取相場は年式・状態・付属品により大きく異なります。本ページ上部の相場カードで、ヤフオク落札の実勢中央値（毎週自動更新）を確認できます。正確な査定額は無料査定でご確認ください。\"}}, {\"@type\": \"Question\", \"name\": \"古いモーグ サブスィークエント37でも買い取ってもらえますか？\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"はい、モーグ サブスィークエント37は中古市場で需要があるため、年式が古くても状態次第で買取可能なケースが多いです。ヴィンテージ価値が評価される個体もあります。\"}}, {\"@type\": \"Question\", \"name\": \"モーグ サブスィークエント37を高く売るにはどうすればいいですか？\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"(1)複数業者で一括査定して相見積もりを取る、(2)純正ケース・付属品・保証書を揃える、(3)軽い清掃で見た目を整える、(4)需要が高まる時期に売る、の4点が基本です。深い修理・改造は自分で行わず業者に任せましょう。\"}}]}" }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"モーグ サブスィークエント37の買取相場と高く売るコツ（実勢データ付き）\", \"datePublished\": \"2026-07-16\", \"dateModified\": \"2026-07-16\", \"author\": {\"@type\": \"Organization\", \"name\": \"楽器買取びより\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"楽器買取びより\"}}" }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"ホーム\", \"item\": \"https://gakkikaitori-biyori.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"シンセ・キーボード買取\", \"item\": \"https://gakkikaitori-biyori.com/articles/synthesizer-kaitori/\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"モーグ サブスィークエント37買取\", \"item\": \"https://gakkikaitori-biyori.com/articles/moog-subsequent37-kaitori/\"}]}" }} />
    </>
  );
}
    ...
    <>
      ...
      <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
        <ol className="flex flex-wrap items-center text-xs text-warm-gray">
          ...
          <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">モーグ サブスィークエント37買取</span></li>
        </ol>
      </nav>
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">モーグ サブスィークエント37買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年8月最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">モーグ サブスィークエント37の買取相場と高く売るコツ</h1>
          <p className="text-warm-gray text-sm leading-relaxed">アナログシンセの名門Moogの人気モデル。太いサウンドで需要があります。中古市場での需要をふまえ、実勢データと高く売るコツを解説します。</p>
          <p className="text-xs text-warm-gray mt-2">更新日: 2026年8月1日</p>
        </header>

        <ModelSpotPriceCard slug="moog-subsequent37-kaitori" modelName="Moog Subsequent 37" />

        <section id="souba" className="mb-10 mt-8">
          <h2 className="font-display text-xl md:text-2xl font-bold text-foreground mb-4">モーグ サブスィークエント37の買取相場（実勢データの見方）</h2>
        ...
        <section id="tips" className="mb-10">
          <h2 className="font-display text-xl md:text-2xl font-bold text-foreground mb-4">モーグ サブスィークエント37を高く売るコツ</h2>
        ...
        <RelatedArticles currentSlug="moog-subsequent37-kaitori" relatedSlugs={["synthesizer-kaitori", "synthesizer-kaitori", "souba-ranking", "takaku-uru-kotsu", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
