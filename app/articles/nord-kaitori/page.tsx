  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Nord買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Nordの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "旧世代Leadで2万〜6万円、ElectroやStageの中〜新世代は8万〜25万円以上が目安です。" } },
      { "@type": "Question", name: "古い世代でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。動作すれば需要があります。新しい世代ほど高評価です。" } },
      { "@type": "Question", name: "Nord Stageは高く売れますか？", acceptedAnswer: { "@type": "Answer", text: "プロ需要が高く、中古市場でも安定した高評価です。" } },
      { "@type": "Question", name: "電源アダプタは必要ですか？", acceptedAnswer: { "@type": "Answer", text: "あると有利です。なくても買取可能な場合があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Nord（ノード）買取おすすめ3社比較｜シンセ・ステージピアノの相場", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Nord（ノード）買取おすすめ3社比較｜シンセ・ステージピアノの相場", item: "https://gakkikaitori-biyori.com/articles/nord-kaitori/" },
  ] };
  return (<>
...
export default function NordKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Nord買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Nord（ノード）買取おすすめ3社比較｜シンセ・ステージピアノの相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Nord（Clavia）のキーボードを売りたい方へ。Nord Stage・Electro・Lead・Piano などシリーズ別の価値、世代（2/3/4等）による評価、状態による査定差を解説します。赤い筐体で知られるプロ定番ブランドです。</p>
        ...
        <div className="article-body">
          ...
          <div className="bg-warm-bg border border-warm-border rounded-xl p-5 my-6">
            ...
            <ul className="space-y-1 text-sm list-disc pl-5">
              <li><a href="/articles/nord-stage-kaitori/" className="text-accent-dark underline">ノード ステージの買取相場</a></li>
              <li><a href="/articles/nord-stage3-kaitori/" className="text-accent-dark underline">ノード ステージ3買取相場</a></li>
            </ul>
          </div>


          <h2 id="souba">買取相場の目安</h2>
          <p>Nordの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、旧世代Leadで2万〜6万円、Electro/Stageの中〜新世代は8万〜25万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Nordを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（Stage・Electro・Lead・Piano）</li>
            <li>世代（新しいほど高評価）</li>
            <li>鍵盤・ノブ・端子の動作</li>
            <li>外装の傷・日焼け</li>
            <li>純正ケース・電源・付属品の有無</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>Nordの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Nordの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">旧世代Leadで2万〜6万円、ElectroやStageの中〜新世代は8万〜25万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。動作すれば需要があります。新しい世代ほど高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Nord Stageは高く売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">プロ需要が高く、中古市場でも安定した高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">電源アダプタは必要ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">あると有利です。なくても買取可能な場合があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="nord-kaitori" relatedSlugs={["synthesizer-kaitori", "keyboard-kaitori", "roland-kaitori", "korg-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
