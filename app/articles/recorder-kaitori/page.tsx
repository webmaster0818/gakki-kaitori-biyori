  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">リコーダー買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "リコーダーの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "プラ製は数百円程度、木製のアルト/テナーは数千〜数万円が目安です。" } },
      { "@type": "Question", name: "使用済みでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "衛生面から木製はヘッド洗浄等の状態が重視されます。" } },
      { "@type": "Question", name: "まとめ売りは有利ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。複数本セットは総額が伸びます。" } },
      { "@type": "Question", name: "バスリコーダーは高いですか？", acceptedAnswer: { "@type": "Answer", text: "木製の大型は比較的高評価です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】リコーダー買取おすすめ3社比較｜木製リコーダーの相場", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】リコーダー買取おすすめ3社比較｜木製リコーダーの相場", item: "https://gakkikaitori-biyori.com/articles/recorder-kaitori/" },
  ] };
  return (<>
...
export default function RecorderKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">リコーダー買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】リコーダー買取おすすめ3社比較｜木製リコーダーの相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">リコーダーを売りたい方へ。木製リコーダー（Moeck・Mollenhauer・Zen-On・YAMAHA）の価値、プラスチック製との違い、衛生面の扱い、まとめ売りのコツを解説します。木製の高級リコーダーは一定の需要があります。</p>
        ...
        <div className="article-body">
          ...
          <p>リコーダーの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、プラ製は数百円程度、木製のアルト/テナーは数千〜数万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>リコーダーを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>木製/プラ製（木製は高評価）</li>
            <li>メーカー（Moeck・Mollenhauer等）</li>
            <li>種類（ソプラノ/アルト/テナー/バス）</li>
            <li>割れ・ヘッドの状態</li>
            <li>ケース・本数（まとめ売り）</li>
          </ul>
          ...
          <p>リコーダーの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">リコーダー買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">リコーダーの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">プラ製は数百円程度、木製のアルト/テナーは数千〜数万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">衛生面から木製はヘッド洗浄等の状態が重視されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。複数本セットは総額が伸びます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">バスリコーダーは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">木製の大型は比較的高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="recorder-kaitori" relatedSlugs={["flute-kaitori", "clarinet-kaitori", "oboe-kaitori", "matome-uri-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
