  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ESP買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ESPの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "GrassRoots/LTDの量産で5,000〜3万円、EDWARDSで2万〜8万円、ESP/E-IIの上位やカスタムは5万〜30万円以上が目安です。" } },
      { "@type": "Question", name: "カスタムオーダー品は高く売れますか？", acceptedAnswer: { "@type": "Answer", text: "仕様によりますが、人気仕様は高評価です。オーダーシートがあると有利です。" } },
      { "@type": "Question", name: "LTDでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。海外生産のLTDも需要があります。" } },
      { "@type": "Question", name: "改造품（パーツ交換）でも買取できますか？", acceptedAnswer: { "@type": "Answer", text: "可能ですが、純正からの変更は評価が下がる場合があります。純正パーツがあれば一緒に。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ESP買取おすすめ3社比較｜エレキギター・ベースの相場と価値", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ESP買取おすすめ3社比較｜エレキギター・ベースの相場と価値", item: "https://gakkikaitori-biyori.com/articles/esp-kaitori/" },
  ] };
  return (<>
...
export default function EspKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ESP買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ESP買取おすすめ3社比較｜エレキギター・ベースの相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">ESP（およびE-II・LTD・EDWARDS・GrassRoots）を売りたい方へ。ラインによる価値の違い、Original Series・カスタムオーダー品の評価、状態による査定差を解説します。ESPは国産ハイエンドとして中古でも高い人気があります。</p>
        ...
        <div className="article-body">
          ...
          <div className="bg-warm-bg border border-warm-border rounded-xl p-5 my-6">
            ...
            <ul className="space-y-1 text-sm list-disc pl-5">
              <li><a href="/articles/esp-horizon-kaitori/" className="text-accent-dark underline">ESP ホライゾンの買取相場</a></li>
            </ul>
          </div>


          <h2 id="souba">買取相場の目安</h2>
          <p>ESPの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、GrassRoots/LTD量産で5,000〜3万円、EDWARDSで2万〜8万円、ESP/E-II上位・カスタムは5万〜30万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ESPを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>ライン（ESP/E-II＞EDWARDS＞LTD/GrassRootsの順で高評価）</li>
            <li>モデル（Horizon・Snapper・M-II・カスタム等）</li>
            <li>カスタムオーダー・限定品か</li>
            <li>フレット・ネック・電装系の状態</li>
            <li>純正ケース・保証書の有無</li>
          </ul>
          ...
          <p>ESPの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ESPの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">GrassRoots/LTDの量産で5,000〜3万円、EDWARDSで2万〜8万円、ESP/E-IIの上位やカスタムは5万〜30万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">カスタムオーダー品は高く売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">仕様によりますが、人気仕様は高評価です。オーダーシートがあると有利です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">LTDでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。海外生産のLTDも需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">改造품（パーツ交換）でも買取できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能ですが、純正からの変更は評価が下がる場合があります。純正パーツがあれば一緒に。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="esp-kaitori" relatedSlugs={["guitar-kaitori", "gibson-kaitori", "fender-kaitori", "ibanez-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
