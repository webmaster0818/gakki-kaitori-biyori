  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">アイバニーズ RG買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "アイバニーズRGの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "Standard（海外製）で1万〜4万円、Premiumで3万〜7万円、日本製Prestigeで5万〜12万円、JEM/Universe等のシグネチャーは10万〜30万円以上が目安です。" } },
      { "@type": "Question", name: "PrestigeとStandardの違いは？", acceptedAnswer: { "@type": "Answer", text: "Prestigeは日本製の上位ライン、Standardは海外製の標準ラインで、相場は数倍の差があります。ヘッドやカタログ表記で確認しましょう。" } },
      { "@type": "Question", name: "ロック式トレモロの不調でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "売却可能です。フローティング調整は定番の作業で、軽度なら大きな減額にはなりにくいです。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】アイバニーズ RG買取相場｜製造国・シリーズ別の価値と査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】アイバニーズ RG買取相場｜製造国・シリーズ別の価値と査定ポイント", item: "https://gakkikaitori-biyori.com/articles/ibanez-rg-kaitori/" },
  ] };
  return (<>
...
export default function IbanezRgKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">アイバニーズ RG買取</span>
        ...
        <div className="article-body">
          ...
          <p>アイバニーズ RGの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、Standardで1万〜4万円、Premiumで3万〜7万円、日本製Prestigeで5万〜12万円、JEM/Universeは10万〜30万円以上とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>アイバニーズ RGを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（日本製Prestigeは高評価、Premium中位、Standard/海外製は入門〜中位）</li>
            <li>トレモロの種類と状態（Edge/Lo-Pro Edge等のオリジナルは加点）</li>
            <li>製造年・限定モデル・シグネチャー（JEM/Universe等は別格）</li>
            <li>フレットの減り・ネックの反り・打痕</li>
          ...
          <p>アイバニーズ RGの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">アイバニーズ RG買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">アイバニーズRGの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Standard（海外製）で1万〜4万円、Premiumで3万〜7万円、日本製Prestigeで5万〜12万円、JEM/Universe等のシグネチャーは10万〜30万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">PrestigeとStandardの違いは？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Prestigeは日本製の上位ライン、Standardは海外製の標準ラインで、相場は数倍の差があります。ヘッドやカタログ表記で確認しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ロック式トレモロの不調でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">売却可能です。フローティング調整は定番の作業で、軽度なら大きな減額にはなりにくいです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Steve Vaiモデル（JEM）は高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。JEMやUniverse（7弦の先駆け）はシグネチャーの人気が高く、標準RGより高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="ibanez-rg-kaitori" relatedSlugs={["guitar-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku", "fender-stratocaster-kaitori"]} />
      </article>
    </>
  );
}
