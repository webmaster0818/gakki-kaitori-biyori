      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <aside className="mt-12 pt-8 border-t border-warm-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link href="/articles/saxophone-kaitori/" className="block bg-white border border-warm-border rounded-xl p-4 hover:border-gold/40 hover:shadow-md transition-all group"><span className="bg-gold/10 text-gold-dark text-xs font-bold px-2 py-0.5 rounded-full">サックス買取</span><h3 className="font-bold text-sm mt-2 group-hover:text-accent transition-colors">サックス買取</h3></Link>
