...
export const metadata: Metadata = {
  ...
  title: "【2026年9月 週次相場更新】Bach買取相場ガイド｜全モデル査定額・高く売るコツ",
  description: "Bach（バック）のトランペット、トロンボーン、フリューゲルホルン買取相場、人気モデル別の査定額目安、高く売る5つのコツ、おすすめ買取業者3社を解説。",
  openGraph: { title: "【2026年9月 週次相場更新】Bach買取相場ガイド｜全モデル査定額・高く売るコツ", description: "Bach（バック）のトランペット、トロンボーン、フリューゲルホルン買取相場、人気モデル別の査定額目安、高く売る5つのコツ、おすすめ買取業者3社を解説。" },
};

function Schema() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"Bach\u306e\u53e4\u3044\u30e2\u30c7\u30eb\u3067\u3082\u8cb7\u53d6\u3057\u3066\u3082\u3089\u3048\u307e\u3059\u304b\uff1f\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"\u306f\u3044\u3001Bach\uff08\u30d0\u30c3\u30af\uff09\u306f\u4e2d\u53e4\u5e02\u5834\u3067\u9700\u8981\u304c\u3042\u308b\u30d6\u30e9\u30f3\u30c9\u3067\u3059\u3002\u88fd\u9020\u5f8c10\u5e74\u301c\u6570\u5341\u5e74\u7d4c\u904e\u3057\u305f\u30e2\u30c7\u30eb\u3067\u3082\u3001\u72b6\u614b\u6b21\u7b2c\u3067\u8cb7\u53d6\u53ef\u80fd\u3067\u3059\u3002\u7279\u306b\u30f4\u30a3\u30f3\u30c6\u30fc\u30b8\u4fa1\u5024\u304c\u3042\u308b\u30e2\u30c7\u30eb\u306f\u65b0\u54c1\u3088\u308a\u9ad8\u5024\u306b\u306a\u308b\u3053\u3068\u3082\u3042\u308a\u307e\u3059\u3002\"}}, {\"@type\": \"Question\", \"name\": \"Bach\u306e\u4ed8\u5c5e\u54c1\u304c\u306a\u3044\u3068\u8cb7\u53d6\u3067\u304d\u307e\u305b\u3093\u304b\uff1f\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"\u672c\u4f53\u306e\u307f\u3067\u3082\u8cb7\u53d6\u53ef\u80fd\u3067\u3059\u304c\u3001\u7d14\u6b63\u30b1\u30fc\u30b9\u30fb\u53d6\u6271\u8aac\u660e\u66f8\u30fb\u4fdd\u8a3c\u66f8\u306a\u3069\u304c\u63c3\u3046\u3068\u67fb\u5b9a\u984d\u304c10\u301c30%\u30a2\u30c3\u30d7\u3057\u307e\u3059\u3002\u53ef\u80fd\u306a\u9650\u308a\u4ed8\u5c5e\u54c1\u3092\u63c3\u3048\u307e\u3057\u3087\u3046\u3002\"}}, {\"@type\": \"Question\", \"name\": \"Bach\u3092\u9ad8\u304f\u58f2\u308b\u30bf\u30a4\u30df\u30f3\u30b0\u306f\uff1f\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"\u65b0\u751f\u6d3b\u524d\uff081\u301c3\u6708\uff09\u3001\u6587\u5316\u796d\u30b7\u30fc\u30ba\u30f3\uff089\u301c10\u6708\uff09\u304c\u4e2d\u53e4\u9700\u8981\u306e\u30d4\u30fc\u30af\u3002\u307e\u305f\u3001\u65b0\u6a5f\u7a2e\u767a\u8868\u524d\u306f\u65e7\u30e2\u30c7\u30eb\u4fa1\u683c\u304c\u4e0b\u304c\u308b\u524d\u306b\u58f2\u5374\u3059\u308b\u306e\u304c\u304a\u3059\u3059\u3081\u3067\u3059\u3002\"}}, {\"@type\": \"Question\", \"name\": \"\u6545\u969c\u3057\u3066\u3044\u308bBach\u3067\u3082\u8cb7\u53d6\u3057\u3066\u3082\u3089\u3048\u307e\u3059\u304b\uff1f\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"\u72b6\u614b\u306b\u3088\u308a\u307e\u3059\u3002\u52d5\u4f5c\u3059\u308b\u72b6\u614b\u306a\u3089\u8cb7\u53d6\u53ef\u80fd\u3001\u660e\u3089\u304b\u306a\u6545\u969c\u3067\u3082\u4fee\u7406\u5de5\u623f\u3092\u6301\u3064\u8cb7\u53d6\u696d\u8005\u306a\u3089\u90e8\u54c1\u53d6\u308a\u76ee\u7684\u3067\u8cb7\u53d6\u3057\u3066\u304f\u308c\u308b\u3053\u3068\u304c\u3042\u308a\u307e\u3059\u3002\"}}]}" }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"Bach\u8cb7\u53d6\u76f8\u5834\u3068\u9ad8\u304f\u58f2\u308b\u5b8c\u5168\u30ac\u30a4\u30c9\", \"datePublished\": \"2026-05-17\", \"dateModified\": \"2026-06-22\", \"author\": {\"@type\": \"Organization\", \"name\": \"\u697d\u5668\u8cb7\u53d6\u3073\u3088\u308a\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"\u697d\u5668\u8cb7\u53d6\u3073\u3088\u308a\"}}" }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"ホーム\", \"item\": \"https://gakkikaitori-biyori.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"記事一覧\", \"item\": \"https://gakkikaitori-biyori.com/articles/\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"Bach買取相場と高く売る完全ガイド\", \"item\": \"https://gakkikaitori-biyori.com/articles/bach-kaitori/\"}]}" }} />
    </>
  );
}
    ...
    <>
      ...
      <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
        <ol className="flex flex-wrap items-center text-xs text-warm-gray">
          ...
          <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Bach買取</span></li>
        </ol>
      </nav>
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          ...
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">Bach買取相場と高く売る完全ガイド</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Bach（バック）は管楽器カテゴリで世界的に高い評価を持つメーカーです。トランペット、トロンボーン、フリューゲルホルンなど、ラインナップが幅広く、中古市場でも安定した需要があります。本記事ではBach（バック）の買取相場・モデル別査定額・高く売るコツを解説します。</p>
        ...
        <div className="article-body">
          ...
          <div className="bg-warm-bg border border-warm-border rounded-xl p-5 my-6">
            ...
            <ul className="space-y-1 text-sm list-disc pl-5">
              <li><a href="/articles/bach-42-trombone-kaitori/" className="text-accent-dark underline">バック 42 トロンボーンの買取相場</a></li>
              <li><a href="/articles/bach-stradivarius-kaitori/" className="text-accent-dark underline">バック ストラディバリの買取相場</a></li>
            </ul>
          </div>

        <h2>1. Bachのブランド概要</h2>
        <p>Bach（バック）は、管楽器カテゴリで長年にわたり愛されてきたメーカーです。トランペット、トロンボーン、フリューゲルホルンを製造し、プロからアマチュアまで幅広い層に支持されています。</p>
        <p>中古市場でのBachは、入門モデルから最上位プロモデルまで価格帯が広く、ヴィンテージ価値のあるモデルは新品以上の値段がつくことも珍しくありません。</p>

        <h2>2. Bachの人気モデル別買取相場</h2>
        ...
        <ol>
          ...
          <li><strong>管楽器専門業者を選ぶ</strong>: Bachを正しく評価できる業者を選ぶ</li>
        </ol>

        <h2>5. Bach買取のおすすめ業者3社</h2>
        <ul>
        ...
        <div className="bg-cream border border-warm-border rounded-2xl p-6 my-8">
          <p className="font-bold text-base mb-4 text-center text-accent-dark">Bachの買取価格を無料で確認</p>
        ...
        <h2>6. よくある質問</h2>
        <details className="border border-warm-border rounded-lg p-4 mb-3"><summary className="font-bold cursor-pointer flex justify-between items-center">Bachの古いモデルでも買取してもらえますか？<svg className="faq-arrow w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg></summary><p className="mt-3 text-sm">はい、Bach（バック）は中古市場で需要があるブランドです。製造後10年〜数十年経過したモデルでも、状態次第で買取可能です。特にヴィンテージ価値があるモデルは新品より高値になることもあります。</p></details>
        <details className="border border-warm-border rounded-lg p-4 mb-3"><summary className="font-bold cursor-pointer flex justify-between items-center">Bachの付属品がないと買取できませんか？<svg className="faq-arrow w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg></summary><p className="mt-3 text-sm">本体のみでも買取可能ですが、純正ケース・取扱説明書・保証書などが揃うと査定額が10〜30%アップします。可能な限り付属品を揃えましょう。</p></details>
