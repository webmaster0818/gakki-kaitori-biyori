...
export const metadata: Metadata = {
  title: "【2026年6月最新】Bach買取相場ガイド｜全モデル査定額・高く売るコツ",
  description: "Bach（バック）のトランペット、トロンボーン、フリューゲルホルン買取相場、人気モデル別の査定額目安、高く売る5つのコツ、おすすめ買取業者3社を解説。",
  openGraph: { title: "【2026年6月最新】Bach買取相場ガイド｜全モデル査定額・高く売るコツ", description: "Bach（バック）のトランペット、トロンボーン、フリューゲルホルン買取相場、人気モデル別の査定額目安、高く売る5つのコツ、おすすめ買取業者3社を解説。" },
};
...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"Bach\u8cb7\u53d6\u76f8\u5834\u3068\u9ad8\u304f\u58f2\u308b\u5b8c\u5168\u30ac\u30a4\u30c9\", \"datePublished\": \"2026-05-17\", \"dateModified\": \"2026-05-17\", \"author\": {\"@type\": \"Organization\", \"name\": \"\u697d\u5668\u8cb7\u53d6\u3073\u3088\u308a\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"\u697d\u5668\u8cb7\u53d6\u3073\u3088\u308a\"}}" }} />
