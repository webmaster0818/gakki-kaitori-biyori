  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ヴィンテージ楽器買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ヴィンテージ楽器はどこで売るのが良いですか？", acceptedAnswer: { "@type": "Answer", text: "ヴィンテージに精通した専門業者で査定するのが鉄則です。一般のリサイクル店では適正評価されない恐れがあります。ヒカカク！で専門業者を含め一括比較しましょう。" } },
      { "@type": "Question", name: "パーツ交換していると価値は下がりますか？", acceptedAnswer: { "@type": "Answer", text: "はい。オリジナルパーツからの変更は減額要因です。外した純正パーツがあれば一緒に査定に。" } },
      { "@type": "Question", name: "年代はどう調べますか？", acceptedAnswer: { "@type": "Answer", text: "シリアル番号やロゴ・仕様から年代を特定できます。業者の鑑定で確認できます。" } },
      { "@type": "Question", name: "状態が悪くても価値がありますか？", acceptedAnswer: { "@type": "Answer", text: "希少なヴィンテージは修理前提でも需要があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ヴィンテージ楽器の買取で損しない方法｜価値を見極めるポイント", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ヴィンテージ楽器の買取で損しない方法｜価値を見極めるポイント", item: "https://gakkikaitori-biyori.com/articles/vintage-gakki-kaitori/" },
  ] };
  return (<>
...
export default function VintageGakkiKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ヴィンテージ楽器買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ヴィンテージ楽器の買取で損しない方法｜価値を見極めるポイント</h1>
          <p className="text-warm-gray text-sm leading-relaxed">ヴィンテージ楽器をお持ちの方へ。ヴィンテージギター・管楽器などの価値を左右する要素、オリジナル度の重要性、専門知識のある業者選び、相場の調べ方を解説します。専門業者を選ばないと大きく損をする可能性があります。</p>
        ...
        <div className="article-body">
          ...
          <p>ヴィンテージ楽器を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>年代・製造期（プリウォー・60年代等は高評価）</li>
            <li>オリジナル度（パーツ・塗装が当時のままか）</li>
            <li>ブランド・モデルの希少性</li>
            <li>状態（弾ける/吹けるか・割れ・腐食）</li>
            <li>専門知識のある業者で査定すること</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>ヴィンテージ楽器の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ヴィンテージ楽器買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ヴィンテージ楽器はどこで売るのが良いですか？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ヴィンテージに精通した専門業者で査定するのが鉄則です。一般のリサイクル店では適正評価されない恐れがあります。ヒカカク！で専門業者を含め一括比較しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">パーツ交換していると価値は下がりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。オリジナルパーツからの変更は減額要因です。外した純正パーツがあれば一緒に査定に。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">年代はどう調べますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">シリアル番号やロゴ・仕様から年代を特定できます。業者の鑑定で確認できます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">状態が悪くても価値がありますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">希少なヴィンテージは修理前提でも需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="vintage-gakki-kaitori" relatedSlugs={["takaku-uru-kotsu", "gibson-kaitori", "fender-kaitori", "selmer-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
