  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ハーモニカ買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ハーモニカの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "単体では数百〜数千円が中心ですが、クロマチックの高級機やセットまとめ売りで数千〜数万円になります。" } },
      { "@type": "Question", name: "使用済みでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "衛生面から未使用・新品同様が好まれます。使用済みは評価が下がるか買取不可の場合があります。" } },
      { "@type": "Question", name: "まとめ売りは有利ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。複数本まとめると総額が大きくなり、買取に応じてもらいやすくなります。" } },
      { "@type": "Question", name: "クロマチックハーモニカは高いですか？", acceptedAnswer: { "@type": "Answer", text: "Hohner等の高級クロマチックは比較的高値がつきます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ハーモニカ買取おすすめ3社比較｜相場とメーカー別の価値", datePublished: "2026-06-05", dateModified: "2026-07-07", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ハーモニカ買取おすすめ3社比較｜相場とメーカー別の価値", item: "https://gakkikaitori-biyori.com/articles/harmonica-kaitori/" },
  ] };
  return (<>
...
export default function HarmonicaKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ハーモニカ買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ハーモニカ買取おすすめ3社比較｜相場とメーカー別の価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">ハーモニカを売りたい方へ。Hohner・TOMBO・SUZUKI などメーカー別の価値、ブルースハープ/クロマチック/複音ハーモニカの違い、衛生面の扱い、まとめ売りのコツを解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>ハーモニカの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、単体は数百〜数千円中心、クロマチック高級機やまとめ売りで数千〜数万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ハーモニカを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>メーカー（Hohner・SUZUKI・TOMBO等）</li>
            <li>種類（ブルースハープ/クロマチック/複音）</li>
            <li>未使用・新品同様か（衛生面で中古は評価が割れる）</li>
            <li>本数・まとめ売り（セットは総額が伸びやすい）</li>
            <li>ケース・箱など付属品</li>
          </ul>
          ...
          <p>ハーモニカの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ハーモニカ買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ハーモニカの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">単体では数百〜数千円が中心ですが、クロマチックの高級機やセットまとめ売りで数千〜数万円になります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">使用済みでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">衛生面から未使用・新品同様が好まれます。使用済みは評価が下がるか買取不可の場合があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">まとめ売りは有利ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。複数本まとめると総額が大きくなり、買取に応じてもらいやすくなります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">クロマチックハーモニカは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Hohner等の高級クロマチックは比較的高値がつきます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="harmonica-kaitori" relatedSlugs={["matome-uri-kaitori", "souba-ichiran", "takaku-uru-kotsu", "kaitori-houhou-hikaku", "saxophone-kaitori"]} />
      </article>
    </>
  );
}
