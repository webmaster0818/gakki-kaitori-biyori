    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <RelatedArticles
          ...
          relatedSlugs={["ochanomizu-gakki-kaitori", "shibuya-gakki-kaitori", "shinjuku-gakki-kaitori", "ikebukuro-gakki-kaitori", "piano-kaitori", "guitar-kaitori", "drum-kaitori", "saxophone-kaitori", "violin-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]}
        />
      </article>
    </>
  );
