  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">宅配買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "楽器の宅配買取は安全ですか？", acceptedAnswer: { "@type": "Answer", text: "配送補償と本人確認がしっかりした業者を選べば安全です。追跡可能な配送を使いましょう。" } },
      { "@type": "Question", name: "梱包はどうすればいいですか？", acceptedAnswer: { "@type": "Answer", text: "ケースに入れ、緩衝材で固定して箱詰めします。ギター等は弦を緩めると安心です。梱包キット提供の業者もあります。" } },
      { "@type": "Question", name: "査定に納得できない場合は？", acceptedAnswer: { "@type": "Answer", text: "キャンセル時に無料返送してくれるか事前に確認しましょう。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】楽器の宅配買取は安全？｜手順・梱包・補償の注意点", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】楽器の宅配買取は安全？｜手順・梱包・補償の注意点", item: "https://gakkikaitori-biyori.com/articles/gakki-takuhai-kaitori/" },
  ] };
  return (<>
...
export default function GakkiTakuhaiKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">宅配買取</span>
        ...
        <div className="article-body">
          ...
          <p>宅配を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>梱包キット・集荷の有無を確認</li>
            <li>配送補償の有無と上限を確認</li>
            <li>キャンセル時の返送料負担を確認</li>
            <li>本人確認書類の提出方法</li>
            <li>大型・繊細な楽器は出張買取も検討</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>宅配の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">楽器の宅配買取は安全ですか？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">配送補償と本人確認がしっかりした業者を選べば安全です。追跡可能な配送を使いましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">梱包はどうすればいいですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ケースに入れ、緩衝材で固定して箱詰めします。ギター等は弦を緩めると安心です。梱包キット提供の業者もあります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">査定に納得できない場合は？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">キャンセル時に無料返送してくれるか事前に確認しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">大型楽器も宅配できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ピアノ・大型アンプ等は宅配に不向きで、出張買取が適しています。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">掲載3社は査定・送料・キャンセルすべて無料です。</div>
            </details>
          </div>
        </div>

        <RelatedArticles currentSlug="gakki-takuhai-kaitori" relatedSlugs={["kaitori-houhou-hikaku", "gakki-sokujitsu-kaitori", "gakki-shucchou-kaitori", "kaitori-nagare", "souba-ichiran"]} />
      </article>
    </>
  );
}
