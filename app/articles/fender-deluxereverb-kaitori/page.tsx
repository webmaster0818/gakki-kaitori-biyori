...
export const metadata: Metadata = {
  title: "フェンダー デラックスリバーブの買取相場｜今週の実勢中央値・高く売るコツ【2026年7月最新】",
    ...
    <>
      ...
      <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
        <ol className="flex flex-wrap items-center text-xs text-warm-gray">
          ...
          <li className="flex items-center"><span className="breadcrumb-sep" /><Link href="/articles/amp-kaitori/" className="hover:text-accent transition-colors">アンプ買取</Link></li>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <RelatedArticles currentSlug="fender-deluxereverb-kaitori" relatedSlugs={["amp-kaitori", "fender-kaitori", "souba-ranking", "takaku-uru-kotsu", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
