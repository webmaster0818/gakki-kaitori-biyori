  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">リッケンバッカー 330買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "リッケンバッカー330の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "現行モデルで8万〜18万円、1960〜70年代のヴィンテージは20万〜60万円以上が目安です。カラーや状態で変動します。" } },
      { "@type": "Question", name: "カラーで評価は変わりますか？", acceptedAnswer: { "@type": "Answer", text: "はい。Fireglo（サンバースト系）やJetglo（黒）など人気カラー、特に希少な廃番色は加点されやすいです。" } },
      { "@type": "Question", name: "12弦の360/12も対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。12弦モデルも買取対象で、独特の需要があります。型番（330/360、6弦/12弦）を確認しましょう。" } },
      { "@type": "Question", name: "配線やトラスロッドが特殊ですが査定に影響しますか？", acceptedAnswer: { "@type": "Answer", text: "リッケンバッカー固有の構造で、不利にはなりません。動作に問題がなければ通常評価です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】リッケンバッカー 330買取相場｜年代・カラー別の価値と査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】リッケンバッカー 330買取相場｜年代・カラー別の価値と査定ポイント", item: "https://gakkikaitori-biyori.com/articles/rickenbacker-330-kaitori/" },
  ] };
  return (<>
...
export default function Rickenbacker330KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">リッケンバッカー 330買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】リッケンバッカー 330買取相場｜年代・カラー別の価値と査定ポイント</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Rickenbacker 330（リッケンバッカー330）を売りたい方へ。煌びやかな高音とジャングリーなサウンドで、ビートルズ／パワーポップ系に愛されるセミアコです。本記事ではカラー（Fireglo/Jetglo/Mapleglo）別の価値、年代の評価、独特なトラスロッドや配線の状態が査定に与える影響を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>リッケンバッカー 330の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、現行で8万〜18万円、1960〜70年代ヴィンテージは20万〜60万円以上とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>リッケンバッカー 330を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>製造年（ヴィンテージは加点、現行も需要安定）</li>
            <li>カラー（Fireglo/Jetglo/Mapleglo、希少色は加点）</li>
            <li>オリジナルパーツ（トースターPU・Rタイプテールピース）の保持</li>
            <li>ボディ・バインディング・ネックの状態、リフィニッシュの有無</li>
            <li>純正ケース・改造の有無</li>
          </ul>
          ...
          <p>リッケンバッカー 330の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">リッケンバッカー 330買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">リッケンバッカー330の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">現行モデルで8万〜18万円、1960〜70年代のヴィンテージは20万〜60万円以上が目安です。カラーや状態で変動します。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">カラーで評価は変わりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。Fireglo（サンバースト系）やJetglo（黒）など人気カラー、特に希少な廃番色は加点されやすいです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">12弦の360/12も対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。12弦モデルも買取対象で、独特の需要があります。型番（330/360、6弦/12弦）を確認しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">配線やトラスロッドが特殊ですが査定に影響しますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">リッケンバッカー固有の構造で、不利にはなりません。動作に問題がなければ通常評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="rickenbacker-330-kaitori" relatedSlugs={["guitar-kaitori", "gibson-es335-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
