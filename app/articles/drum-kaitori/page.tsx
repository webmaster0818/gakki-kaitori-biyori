  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <RelatedArticles
          currentSlug="drum-kaitori"
          relatedSlugs={["guitar-kaitori", "bass-kaitori", "roland-kaitori", "pearl-kaitori", "ludwig-kaitori", "sonor-kaitori", "tokyo-gakki-kaitori", "ochanomizu-gakki-kaitori", "osaka-gakki-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]}
        />
      </article>
    </>
  );
