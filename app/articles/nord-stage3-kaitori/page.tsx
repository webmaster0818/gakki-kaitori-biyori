  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ノード ステージ3買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ノード ステージ3の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "モデル・状態により、中古買取で12万〜30万円程度が目安です。状態良好・付属品完備なら上限寄りになります。" } },
      { "@type": "Question", name: "ノードは買取需要がありますか？", acceptedAnswer: { "@type": "Answer", text: "はい。プロ・セミプロの定番で中古需要が高く、安定して買取されます。" } },
      { "@type": "Question", name: "鍵盤数で評価は違いますか？", acceptedAnswer: { "@type": "Answer", text: "88/76/Compactで需要差があり、相場も変わります。型番を確認しましょう。" } },
      { "@type": "Question", name: "ペダルやケースがないと不利ですか？", acceptedAnswer: { "@type": "Answer", text: "純正ペダル・ケースが揃うと評価が上がります。なくても買取可能です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ノード ステージ3買取相場｜ステージピアノ／シンセの価値と査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ノード ステージ3買取相場｜ステージピアノ／シンセの価値と査定ポイント", item: "https://gakkikaitori-biyori.com/articles/nord-stage3-kaitori/" },
  ] };
  return (<>
...
export default function NordStage3KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ノード ステージ3買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ノード ステージ3買取相場｜ステージピアノ／シンセの価値と査定ポイント</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Nord Stage 3（ノード ステージ3）を売りたい方へ。ピアノ・オルガン・シンセを統合したプロ定番のステージキーボードで、ライブ／レコーディングで高く支持されています。本記事では鍵盤数（88/76/Compact）の違い、状態が査定に与える影響、高く売るコツを解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>ノード ステージ3の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、中古買取で12万〜30万円程度（状態良好・付属品完備は上限寄り）とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ノード ステージ3を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>モデル・鍵盤数（Stage 3 88/76/Compact）と世代</li>
            <li>動作確認（鍵盤・各セクション・端子）</li>
            <li>外装の傷・打痕、鍵盤の状態</li>
            <li>付属品（電源・ペダル・ケース）の有無</li>
            <li>改造・リペア歴の有無</li>
          </ul>
          ...
          <p>ノード ステージ3の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ノード ステージ3買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ノード ステージ3の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">モデル・状態により、中古買取で12万〜30万円程度が目安です。状態良好・付属品完備なら上限寄りになります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ノードは買取需要がありますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。プロ・セミプロの定番で中古需要が高く、安定して買取されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">鍵盤数で評価は違いますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">88/76/Compactで需要差があり、相場も変わります。型番を確認しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ペダルやケースがないと不利ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">純正ペダル・ケースが揃うと評価が上がります。なくても買取可能です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="nord-stage3-kaitori" relatedSlugs={["synthesizer-kaitori", "korg-minilogue-kaitori", "piano-kaitori", "takaku-uru-kotsu", "souba-ichiran"]} />
      </article>
    </>
  );
}
