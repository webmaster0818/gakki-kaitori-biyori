  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">テクニクス買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "テクニクスの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "旧SL-1200(MK系)で2万〜8万円、新復刻機（MK7/GR/G）は8万〜20万円以上が目安です。" } },
      { "@type": "Question", name: "古いMK3/MK5でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。DJ定番として安定需要があります。" } },
      { "@type": "Question", name: "ペアだと高いですか？", acceptedAnswer: { "@type": "Answer", text: "DJ用途ではペアの需要が高く総額が伸びます。" } },
      { "@type": "Question", name: "オーディオ用テクニクスも対象ですか？", acceptedAnswer: { "@type": "Answer", text: "アンプ・スピーカー等も買取対象の場合があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】テクニクス（Technics）買取おすすめ3社比較｜SL-1200の相場", datePublished: "2026-06-05", dateModified: "2026-07-07", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】テクニクス（Technics）買取おすすめ3社比較｜SL-1200の相場", item: "https://gakkikaitori-biyori.com/articles/technics-kaitori/" },
  ] };
  return (<>
...
export default function TechnicsKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">テクニクス買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】テクニクス（Technics）買取おすすめ3社比較｜SL-1200の相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">テクニクス（Technics）を売りたい方へ。DJ定番のSL-1200シリーズを中心に、年式（MK2〜MK7・復刻機）による価値の違い、オーディオ機器の評価、状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>テクニクスの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、旧SL-1200(MK系)で2万〜8万円、新復刻機(MK7/GR/G)は8万〜20万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>テクニクスを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>機種（SL-1200/1210シリーズ）と年式</li>
            <li>MK2〜MK7・GR/G・復刻機の別</li>
            <li>回転・ピッチ・トーンアームの動作</li>
            <li>外装・ボタン・端子の状態</li>
          ...
          <p>テクニクスの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">テクニクス買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">テクニクスの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">旧SL-1200(MK系)で2万〜8万円、新復刻機（MK7/GR/G）は8万〜20万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いMK3/MK5でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。DJ定番として安定需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ペアだと高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">DJ用途ではペアの需要が高く総額が伸びます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">オーディオ用テクニクスも対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">アンプ・スピーカー等も買取対象の場合があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="technics-kaitori" relatedSlugs={["turntable-kaitori", "dj-kizai-kaitori", "pioneer-dj-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
