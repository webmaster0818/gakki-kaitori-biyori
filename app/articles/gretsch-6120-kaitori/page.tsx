  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">グレッチ 6120買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "グレッチ6120の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "日本製のProfessional Collectionで5万〜12万円、USA製/Custom Shopで12万〜30万円、1950〜60年代のヴィンテージは数十万〜百万円超が目安です。" } },
      { "@type": "Question", name: "日本製とUSA製で評価は違いますか？", acceptedAnswer: { "@type": "Answer", text: "USA製・Custom Shopが上位ですが、日本製のProfessional Collectionも品質が高く一定の評価があります。型番で確認しましょう。" } },
      { "@type": "Question", name: "ビグスビーの不調があっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "売却可能です。ビグスビー（トレモロ）は定番パーツで、軽度の不調は大きな減額にはなりにくいです。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】グレッチ 6120買取相場｜年代・仕様別の価値とフルアコの査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】グレッチ 6120買取相場｜年代・仕様別の価値とフルアコの査定ポイント", item: "https://gakkikaitori-biyori.com/articles/gretsch-6120-kaitori/" },
  ] };
  return (<>
...
export default function Gretsch6120KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">グレッチ 6120買取</span>
        ...
        <div className="article-body">
          ...
          <p>グレッチ 6120の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、日本製で5万〜12万円、USA製/Custom Shopで12万〜30万円、1950〜60年代ヴィンテージは数十万〜百万円超とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>グレッチ 6120を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>製造国（USAは高評価、日本製プロラインは中〜上位）と製造年</li>
            <li>ヴィンテージ（1950〜60年代のオリジナルは高額）</li>
            <li>Filter'Tron/DynaSonic等オリジナルピックアップとビグスビーの保持</li>
            <li>フルアコ特有のボディ割れ・バインディング・トップの状態</li>
            <li>純正ケース・カラー（オレンジ等）・改造の有無</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>グレッチ 6120の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">グレッチ 6120買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">グレッチ6120の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">日本製のProfessional Collectionで5万〜12万円、USA製/Custom Shopで12万〜30万円、1950〜60年代のヴィンテージは数十万〜百万円超が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">日本製とUSA製で評価は違いますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">USA製・Custom Shopが上位ですが、日本製のProfessional Collectionも品質が高く一定の評価があります。型番で確認しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ビグスビーの不調があっても売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">売却可能です。ビグスビー（トレモロ）は定番パーツで、軽度の不調は大きな減額にはなりにくいです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">フルアコのボディ割れは減額になりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">割れ・剥がれは減額要因です。ただし人気機種のため、状態を正直に伝えれば値はつきます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="gretsch-6120-kaitori" relatedSlugs={["guitar-kaitori", "gibson-es335-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
