  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Mesa/Boogie買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Mesa/Boogieの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "小型で2万〜6万円、Rectifier/Mark等のヘッドは8万〜25万円以上が目安です。" } },
      { "@type": "Question", name: "Rectifierは高く売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。定番ハイゲインアンプとして高評価です。" } },
      { "@type": "Question", name: "古いMarkシリーズでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "年代物のMark系も需要があります。" } },
      { "@type": "Question", name: "コンボでも対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。買取対象です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Mesa/Boogieアンプ買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Mesa/Boogieアンプ買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/mesaboogie-kaitori/" },
  ] };
  return (<>
...
export default function MesaboogieKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Mesa/Boogie買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Mesa/Boogieアンプ買取おすすめ3社比較｜相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Mesa/Boogie（メサブギー）のアンプを売りたい方へ。Dual/Triple Rectifier・Mark IV/V などの価値、真空管アンプとしての高い需要、状態による査定差を解説します。ハイゲインアンプの名門です。</p>
        ...
        <div className="article-body">
          ...
          <div className="bg-warm-bg border border-warm-border rounded-xl p-5 my-6">
            ...
            <ul className="space-y-1 text-sm list-disc pl-5">
              <li><a href="/articles/mesaboogie-markv-kaitori/" className="text-accent-dark underline">メサブギー マークVの買取相場</a></li>
            </ul>
          </div>


          <h2 id="souba">買取相場の目安</h2>
          <p>Mesa/Boogieの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、小型で2万〜6万円、Rectifier/Mark等のヘッドは8万〜25万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Mesa/Boogieを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（Rectifier・Markシリーズは高評価）</li>
            <li>ヘッド/コンボ・出力W</li>
            <li>真空管の状態・動作の正常性</li>
            <li>外装・トーレックスの状態</li>
            <li>フットスイッチ等の付属品</li>
          ...
          <p>Mesa/Boogieの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">Mesa/Boogie買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Mesa/Boogieの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">小型で2万〜6万円、Rectifier/Mark等のヘッドは8万〜25万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Rectifierは高く売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。定番ハイゲインアンプとして高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いMarkシリーズでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">年代物のMark系も需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">コンボでも対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
        ...
        <RelatedArticles currentSlug="mesaboogie-kaitori" relatedSlugs={["guitar-amp-kaitori", "marshall-kaitori", "orange-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
