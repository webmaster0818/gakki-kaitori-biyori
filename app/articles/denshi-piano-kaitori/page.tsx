...
function FaqSchema() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"ホーム\", \"item\": \"https://gakkikaitori-biyori.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"記事一覧\", \"item\": \"https://gakkikaitori-biyori.com/articles/\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"【2026年最新】電子ピアノ買取相場ガイド｜YAMAHA・Roland・KAWAI メーカー別に徹底解説\", \"item\": \"https://gakkikaitori-biyori.com/articles/denshi-piano-kaitori/\"}]}" }} />
    </>
  );
}
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <RelatedArticles
          ...
          relatedSlugs={["piano-kaitori", "keyboard-kaitori", "midi-keyboard-kaitori", "yamaha-kaitori", "kawai-kaitori", "casio-kaitori", "roland-kaitori", "tokyo-gakki-kaitori", "ochanomizu-gakki-kaitori", "osaka-gakki-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]}
        />
      </article>
    </>
  );
