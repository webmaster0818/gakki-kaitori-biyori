  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ヤマハ C3買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ヤマハC3の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "年式・状態により幅がありますが、中古買取で10万〜40万円程度が目安です。新しめで状態良好な個体は上限寄りになります。正確な額は無料査定でご確認ください。" } },
      { "@type": "Question", name: "製造番号で年式が分かりますか？", acceptedAnswer: { "@type": "Answer", text: "はい。ヤマハの製造番号から製造年式が判定でき、年代が新しいほど高評価になる傾向です。" } },
      { "@type": "Question", name: "グランドピアノは搬出が大変ですが買取できますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。掲載3社のうちウリエル等は出張買取に対応し、専門の運送で搬出します。設置階や経路を事前に伝えるとスムーズです。" } },
      { "@type": "Question", name: "古いC3でも値段がつきますか？", acceptedAnswer: { "@type": "Answer", text: "はい。ヤマハグランドは海外需要もあり、古くても状態次第で買取されます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ヤマハ C3買取相場｜製造番号・年式別の価値とグランドピアノの査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ヤマハ C3買取相場｜製造番号・年式別の価値とグランドピアノの査定ポイント", item: "https://gakkikaitori-biyori.com/articles/yamaha-c3-kaitori/" },
  ] };
  return (<>
...
export default function YamahaC3KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ヤマハ C3買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ヤマハ C3買取相場｜製造番号・年式別の価値とグランドピアノの査定ポイント</h1>
          <p className="text-warm-gray text-sm leading-relaxed">YAMAHA C3（ヤマハC3）を売りたい方へ。奥行き186cmの定番グランドピアノで、家庭・教室・ホールで広く使われる人気機種です。本記事では製造番号による年式判定、年代別の価値、外装・内部（弦・ハンマー・アクション）の状態が査定に与える影響を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>ヤマハ C3の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、中古買取で10万〜40万円程度（年式新しめ・状態良好は上限寄り）とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ヤマハ C3を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>製造番号・製造年式（新しいほど高評価、年代で相場が変わる）</li>
            <li>外装の状態（傷・打痕・艶）と内部（弦・ハンマー・アクション）のコンディション</li>
            <li>調律・整調の状態、湿気によるサビ・カビの有無</li>
            <li>設置環境・搬出経路（クレーン要否が実務に影響）</li>
            <li>椅子・付属品・保証書の有無</li>
          </ul>
          ...
          <p>ヤマハ C3の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ヤマハ C3買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ヤマハC3の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">年式・状態により幅がありますが、中古買取で10万〜40万円程度が目安です。新しめで状態良好な個体は上限寄りになります。正確な額は無料査定でご確認ください。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">製造番号で年式が分かりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。ヤマハの製造番号から製造年式が判定でき、年代が新しいほど高評価になる傾向です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">グランドピアノは搬出が大変ですが買取できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能です。掲載3社のうちウリエル等は出張買取に対応し、専門の運送で搬出します。設置階や経路を事前に伝えるとスムーズです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いC3でも値段がつきますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。ヤマハグランドは海外需要もあり、古くても状態次第で買取されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
