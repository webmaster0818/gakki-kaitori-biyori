  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">アイバニーズ TS808買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "TS808の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "現行リイシューで5,000〜1.5万円、ヴィンテージの旧ロゴ個体は3万〜8万円以上が目安です。チップや基板の世代で大きく変わります。" } },
      { "@type": "Question", name: "ヴィンテージのTS808が高いのはなぜですか？", acceptedAnswer: { "@type": "Answer", text: "初期のオペアンプ（JRC4558D等）を搭載した旧ロゴ個体が音色面で評価され、希少性からプレミア化しているためです。" } },
      { "@type": "Question", name: "動作しなくても売れますか？", acceptedAnswer: { "@type": "Answer", text: "部品取りや修理前提で買取される場合があります。状態を正直に伝えましょう。" } },
      { "@type": "Question", name: "改造（MOD）品は不利ですか？", acceptedAnswer: { "@type": "Answer", text: "オリジナルが最も高評価ですが、有名ビルダーのMODは需要がある場合もあります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】アイバニーズ TS808買取相場｜年代・仕様別の価値とオーバードライブの査定ポイント", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】アイバニーズ TS808買取相場｜年代・仕様別の価値とオーバードライブの査定ポイント", item: "https://gakkikaitori-biyori.com/articles/ibanez-ts808-kaitori/" },
  ] };
  return (<>
...
export default function IbanezTs808KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">アイバニーズ TS808買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】アイバニーズ TS808買取相場｜年代・仕様別の価値とオーバードライブの査定ポイント</h1>
        ...
        <div className="article-body">
          ...
          <p>アイバニーズ TS808の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、現行リイシューで5,000〜1.5万円、ヴィンテージ旧ロゴは3万〜8万円以上とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>アイバニーズ TS808を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>年代・仕様（オリジナルのヴィンテージは高額、現行リイシューは手頃）</li>
            <li>オペアンプチップ（JRC4558D等）の有無・基板の世代</li>
            <li>動作確認（ノイズ・ガリ・スイッチの効き）</li>
            <li>外装の状態・ノブ・電池蓋などの欠品</li>
            <li>改造（MOD）の有無・付属品</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>アイバニーズ TS808の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">アイバニーズ TS808買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">TS808の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">現行リイシューで5,000〜1.5万円、ヴィンテージの旧ロゴ個体は3万〜8万円以上が目安です。チップや基板の世代で大きく変わります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ヴィンテージのTS808が高いのはなぜですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">初期のオペアンプ（JRC4558D等）を搭載した旧ロゴ個体が音色面で評価され、希少性からプレミア化しているためです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">動作しなくても売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">部品取りや修理前提で買取される場合があります。状態を正直に伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">改造（MOD）品は不利ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">オリジナルが最も高評価ですが、有名ビルダーのMODは需要がある場合もあります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="ibanez-ts808-kaitori" relatedSlugs={["ibanez-ts9-kaitori", "boss-ds1-kaitori", "effector-kaitori", "takaku-uru-kotsu", "souba-ichiran"]} />
      </article>
    </>
  );
}
