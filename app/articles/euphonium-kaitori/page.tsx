...
export const metadata: Metadata = {
  alternates: { canonical: 'https://gakkikaitori-biyori.com/articles/euphonium-kaitori/' },
  title: "【2026年最新】ユーフォニアム買取おすすめ3社比較｜相場とメーカー別の価値",
  description: "ユーフォニアム買取の相場とおすすめ業者3社を比較。YAMAHA・Besson・Willson などメーカー別、コンペンセイティングの有無による価値、状態の査定差を解説。",
};
  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ユーフォニアム買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ユーフォニアムの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "学生用で1万〜5万円、YAMAHA中上位やBesson等のプロ用は5万〜30万円以上が目安です。" } },
      { "@type": "Question", name: "凹みがあっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "軽度なら買取可能ですが、大きな凹み・詰まりは減額要因です。" } },
      { "@type": "Question", name: "コンペンセイティングモデルは高いですか？", acceptedAnswer: { "@type": "Answer", text: "はい。プロ用のコンペンセイティング機は高評価です。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ユーフォニアム買取おすすめ3社比較｜相場とメーカー別の価値", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ユーフォニアム買取おすすめ3社比較｜相場とメーカー別の価値", item: "https://gakkikaitori-biyori.com/articles/euphonium-kaitori/" },
  ] };
  return (<>
...
export default function EuphoniumKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ユーフォニアム買取</span>
        ...
        <div className="article-body">
          ...
          <p>ユーフォニアムの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、学生用で1万〜5万円、YAMAHA中上位やBesson等のプロ用は5万〜30万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ユーフォニアムを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>メーカー（YAMAHA・Besson・Willson・Sterling等）</li>
            <li>コンペンセイティングの有無・バルブ数</li>
            <li>ラッカー/銀メッキ等の仕上げと状態</li>
            <li>凹み・詰まり・動作の正常性</li>
          ...
          <p>ユーフォニアムの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ユーフォニアム買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ユーフォニアムの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">学生用で1万〜5万円、YAMAHA中上位やBesson等のプロ用は5万〜30万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">軽度なら買取可能ですが、大きな凹み・詰まりは減額要因です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">コンペンセイティングモデルは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。プロ用のコンペンセイティング機は高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。付属品が揃うと評価が上がります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="euphonium-kaitori" relatedSlugs={["trumpet-kaitori", "trombone-kaitori", "saxophone-kaitori", "yamaha-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
