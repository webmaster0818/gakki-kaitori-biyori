  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Jupiter買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Jupiterの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "学生用で5,000〜3万円、中級機で1万〜5万円が目安です。" } },
      { "@type": "Question", name: "吹奏楽で使った楽器でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。状態が良ければ需要があります。" } },
      { "@type": "Question", name: "凹みがあっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "軽度なら可能ですが減額されます。" } },
      { "@type": "Question", name: "フルートも対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。買取対象です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Jupiter管楽器買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Jupiter管楽器買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/jupiter-kaitori/" },
  ] };
  return (<>
...
export default function JupiterKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Jupiter買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Jupiter管楽器買取おすすめ3社比較｜相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Jupiter（ジュピター）の管楽器を売りたい方へ。トランペット・サックス・フルート・トロンボーンなど、学生〜中級機としての価値、状態による査定差を解説します。台湾の総合管楽器メーカーで吹奏楽需要があります。</p>
        ...
        <div className="article-body">
          ...
          <p>Jupiterの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、学生用で5,000〜3万円、中級機で1万〜5万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Jupiterを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>楽器種別（サックス・トランペット・フルート等）</li>
            <li>学生用/中級用のグレード</li>
            <li>凹み・詰まり・動作の正常性</li>
            <li>仕上げの状態</li>
          ...
          <p>Jupiterの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">Jupiter買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Jupiterの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">学生用で5,000〜3万円、中級機で1万〜5万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">吹奏楽で使った楽器でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。状態が良ければ需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
            ...
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">フルートも対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
        ...
        <RelatedArticles currentSlug="jupiter-kaitori" relatedSlugs={["trumpet-kaitori", "saxophone-kaitori", "flute-kaitori", "yamaha-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
