  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ウクレレ買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ウクレレの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "量産合板モデルで1,000〜5,000円、国産・コア単板の中級で5,000〜2万円、KAMAKA・Martin等のハワイ製高級は2万〜10万円以上が目安です。ヴィンテージMartinはさらに高額なことも。" } },
      { "@type": "Question", name: "合板のウクレレでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "売却可能です。ただしコア無垢材のモデルと比べると評価は低めです。ブランドと状態次第で値がつきます。" } },
      { "@type": "Question", name: "KAMAKAは高く売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。KAMAKAはハワイ製の名門で中古需要が高く、状態が良ければ高価買取が期待できます。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ウクレレ買取おすすめ3社比較｜ブランド別の相場と価値", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ウクレレ買取おすすめ3社比較｜ブランド別の相場と価値", item: "https://gakkikaitori-biyori.com/articles/ukulele-kaitori/" },
  ] };
  return (<>
...
export default function UkuleleKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ウクレレ買取</span>
        ...
        <div className="article-body">
          ...
          <p>ウクレレの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、量産合板で1,000〜5,000円、コア単板中級で5,000〜2万円、KAMAKA/Martin等のハワイ製高級は2万〜10万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ウクレレを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>ブランド（KAMAKA・Martin・KoAloha等のハワイ製は高評価）</li>
            <li>材（ハワイアンコア無垢は高評価、合板は低め）</li>
            <li>サイズ（ソプラノ/コンサート/テナー/バリトン）</li>
            <li>割れ・ネックの状態・ペグの動作</li>
            <li>純正ケース・保証書の有無</li>
          </ul>
          ...
          <p>ウクレレの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ウクレレの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">量産合板モデルで1,000〜5,000円、国産・コア単板の中級で5,000〜2万円、KAMAKA・Martin等のハワイ製高級は2万〜10万円以上が目安です。ヴィンテージMartinはさらに高額なことも。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">合板のウクレレでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">売却可能です。ただしコア無垢材のモデルと比べると評価は低めです。ブランドと状態次第で値がつきます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">KAMAKAは高く売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。KAMAKAはハワイ製の名門で中古需要が高く、状態が良ければ高価買取が期待できます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いウクレレでも価値がありますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ヴィンテージMartinなど、古くても希少価値の高い個体があります。状態とブランドで判断されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="ukulele-kaitori" relatedSlugs={["guitar-kaitori", "martin-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
