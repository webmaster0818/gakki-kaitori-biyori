...
export const metadata: Metadata = {
  alternates: { canonical: 'https://gakkikaitori-biyori.com/articles/sendai-gakki-kaitori/' },
  title: "仙台の楽器買取はどこがいい？ギター・管楽器の持ち込みと出張・宅配の選び方【2026年7月】",
  description:
    "仙台で楽器を売るならどこがいい？仙台駅周辺の専門店事情、出張・店頭・宅配の違いと買取相場の目安、おすすめ3社の比較、高く売るコツまで解説。無料査定だけの利用もOK。ギター・ピアノ・管楽器に対応。",
  openGraph: {
    title: "仙台の楽器買取はどこがいい？相場とおすすめ3社を比較【2026年7月】",
    description: "仙台で楽器を売るなら。買取相場の目安とおすすめ3社の比較、高く売るコツを解説。",
  },
};
...
function FaqSchema() {
  ...
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "【2026年7月最新】楽器買取 仙台おすすめ3選｜仙台駅周辺の専門店も比較",
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          ...
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">
            【2026年7月最新】楽器買取 仙台おすすめ3選｜仙台駅周辺の専門店も徹底比較
          </h1>
        ...
        <div className="article-body">
          ...
          <div className="bg-gold/10 border border-warm-border rounded-xl p-5 my-8">
            ...
            <Link href="/articles/guitar-kaitori-sendai/" className="text-accent font-medium text-sm hover:underline">仙台のギター買取おすすめ3社と相場を見る →</Link>
          </div>
        ...
        <RelatedArticles
          ...
          relatedSlugs={["guitar-kaitori-sendai", "morioka-gakki-kaitori", "yamagata-gakki-kaitori", "fukushima-gakki-kaitori", "tokyo-gakki-kaitori", "piano-kaitori", "guitar-kaitori", "drum-kaitori", "saxophone-kaitori", "violin-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]}
        />
      </article>
    </>
  );
