  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ヤナギサワ AWO10買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ヤナギサワAWO10の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "年式・状態により、中古買取で10万〜25万円程度が目安です。状態良好・オーバーホール済みなら上限寄りになります。" } },
      { "@type": "Question", name: "ヤナギサワは買取需要がありますか？", acceptedAnswer: { "@type": "Answer", text: "はい。サックス専業メーカーとして評価が高く、プロ・上級者の需要が安定しています。" } },
      { "@type": "Question", name: "素材違い（ブロンズ等）で評価は変わりますか？", acceptedAnswer: { "@type": "Answer", text: "はい。上位素材・仕様のモデルは加点対象です。型番を確認しましょう。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ヤナギサワ AWO10買取相場｜アルトサックスの価値と査定ポイント", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ヤナギサワ AWO10買取相場｜アルトサックスの価値と査定ポイント", item: "https://gakkikaitori-biyori.com/articles/yanagisawa-awo10-kaitori/" },
  ] };
  return (<>
...
export default function YanagisawaAwo10KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ヤナギサワ AWO10買取</span>
        ...
        <div className="article-body">
          ...
          <p>ヤナギサワ AWO10の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、中古買取で10万〜25万円程度（状態良好・オーバーホール済みは上限寄り）とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ヤナギサワ AWO10を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>モデル・素材（AWO10/AWO20等、上位素材は加点）と年式</li>
            <li>タンポ・キイの動作・気密性</li>
            <li>管体のへこみ・ラッカー/メッキの状態</li>
            <li>オーバーホール歴・リペア歴</li>
            <li>純正ケース・付属品の有無</li>
          </ul>
          ...
          <p>ヤナギサワ AWO10の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ヤナギサワ AWO10買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ヤナギサワAWO10の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">年式・状態により、中古買取で10万〜25万円程度が目安です。状態良好・オーバーホール済みなら上限寄りになります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ヤナギサワは買取需要がありますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。サックス専業メーカーとして評価が高く、プロ・上級者の需要が安定しています。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">素材違い（ブロンズ等）で評価は変わりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。上位素材・仕様のモデルは加点対象です。型番を確認しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">状態とメンテナンス次第で買取されます。オーバーホール済みは有利です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="yanagisawa-awo10-kaitori" relatedSlugs={["yamaha-yas875-kaitori", "saxophone-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
