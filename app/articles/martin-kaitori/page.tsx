...
export const metadata: Metadata = {
  ...
  title: "Martin買取はどこがいい？D-28等の相場とおすすめ3社【2026年9月】",
  description:
...
function FaqSchema() {
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年9月最新】Martin買取おすすめ3社比較｜アコギの王様の相場・高く売るコツ", datePublished: "2026-04-26", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          ...
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年9月最新】Martin買取おすすめ3社比較｜アコギの王様の相場と高く売るコツ</h1>
