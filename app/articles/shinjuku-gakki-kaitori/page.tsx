...
export const metadata: Metadata = {
  title: "【2026年最新】楽器買取 新宿おすすめ3選｜出張・店頭・宅配を比較",
  description:
    "新宿で楽器を売るならどこがいい？新宿対応の楽器買取おすすめ3社を徹底比較。新宿・高田馬場・中野エリアの買取事情、出張・店頭・宅配買取の違い、高く売るコツまで解説。",
  openGraph: {
    title: "【2026年最新】楽器買取 新宿おすすめ3選｜出張・店頭・宅配を比較",
    description: "新宿で楽器を売るなら。おすすめ買取3社の比較と高く売るコツを徹底解説。",
  },
};
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <aside className="mt-12 pt-8 border-t border-warm-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Link href="/articles/ikebukuro-gakki-kaitori/" className="block bg-white border border-warm-border rounded-xl p-4 hover:border-gold/40 hover:shadow-md transition-all group">
              <span className="bg-gold/10 text-gold-dark text-xs font-bold px-2 py-0.5 rounded-full">池袋エリア</span>
              <h3 className="font-bold text-sm mt-2 group-hover:text-accent transition-colors">池袋エリア</h3>
            </Link>
