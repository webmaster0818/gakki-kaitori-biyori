  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">タカミネ買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "タカミネの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "量産入門で5,000〜2万円、Pro Seriesで2万〜8万円、限定・上位機は8万〜20万円以上が目安です。" } },
      { "@type": "Question", name: "エレアコ機能は評価されますか？", acceptedAnswer: { "@type": "Answer", text: "はい。ライブ需要があり、ピックアップが正常なら有利です。" } },
      { "@type": "Question", name: "古いタカミネでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "年式や仕様次第で需要があります。" } },
      { "@type": "Question", name: "海外モデルでも買取できますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。仕様により評価されます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】タカミネ（Takamine）買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】タカミネ（Takamine）買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/takamine-kaitori/" },
  ] };
  return (<>
...
export default function TakamineKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">タカミネ買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】タカミネ（Takamine）買取おすすめ3社比較｜相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">タカミネ（Takamine）のアコースティック/エレアコを売りたい方へ。Pro Series・SANTA FE・限定モデルの価値、CTシステム等のピックアップ評価、状態による査定差を解説します。国産エレアコの定番として安定需要があります。</p>
        ...
        <div className="article-body">
          ...
          <p>タカミネの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、量産入門で5,000〜2万円、Pro Seriesで2万〜8万円、限定・上位機は8万〜20万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>タカミネを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（Pro Series・SANTA FE・限定は高評価）</li>
            <li>単板/合板・トップ材</li>
            <li>ピックアップ（CTシステム等）の動作</li>
          ...
          <p>タカミネの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">タカミネの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">量産入門で5,000〜2万円、Pro Seriesで2万〜8万円、限定・上位機は8万〜20万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">エレアコ機能は評価されますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。ライブ需要があり、ピックアップが正常なら有利です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いタカミネでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">年式や仕様次第で需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">海外モデルでも買取できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能です。仕様により評価されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="takamine-kaitori" relatedSlugs={["acoustic-guitar-kaitori", "guitar-kaitori", "yamaha-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
