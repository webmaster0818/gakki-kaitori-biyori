  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">ターンテーブル買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ターンテーブルの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "一般機で数千〜2万円、Technics SL-1200系は機種・状態により2万〜10万円以上が目安です。新しい復刻機ほど高額傾向です。" } },
      { "@type": "Question", name: "片方だけ（1台）でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。ただしDJ用途ではペアの方が需要があり総額が伸びます。" } },
      { "@type": "Question", name: "古いSL-1200でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。MK2〜MK5なども安定した需要があります。" } },
      { "@type": "Question", name: "カートリッジは査定対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。SHURE等の人気カートリッジは別途評価されます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ターンテーブル買取おすすめ3社比較｜Technics SL-1200の相場", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ターンテーブル買取おすすめ3社比較｜Technics SL-1200の相場", item: "https://gakkikaitori-biyori.com/articles/turntable-kaitori/" },
  ] };
  return (<>
...
export default function TurntableKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ターンテーブル買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ターンテーブル買取おすすめ3社比較｜Technics SL-1200の相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">ターンテーブルを売りたい方へ。Technics SL-1200シリーズを中心に、Pioneer DJ・Vestaxなどメーカー別の価値、DJ用途での需要、状態による査定差を解説します。SL-1200は中古市場で非常に人気の高い定番機です。</p>
        ...
        <div className="article-body">
          ...
          <p>ターンテーブルの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、一般機で数千〜2万円、Technics SL-1200系は機種・状態で2万〜10万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ターンテーブルを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>メーカー・機種（Technics SL-1200/1210シリーズは高評価）</li>
            <li>年式・モデル（MK2〜MK7、復刻機）</li>
            <li>動作の正常性（回転・ピッチ・トーンアーム）</li>
            <li>外装・ボタン・端子の状態</li>
            <li>純正カートリッジ・付属品の有無</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>ターンテーブルの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ターンテーブル買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ターンテーブルの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">一般機で数千〜2万円、Technics SL-1200系は機種・状態により2万〜10万円以上が目安です。新しい復刻機ほど高額傾向です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">片方だけ（1台）でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能です。ただしDJ用途ではペアの方が需要があり総額が伸びます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いSL-1200でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。MK2〜MK5なども安定した需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">カートリッジは査定対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。SHURE等の人気カートリッジは別途評価されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="turntable-kaitori" relatedSlugs={["dj-kizai-kaitori", "audio-interface-kaitori", "souba-ichiran", "takaku-uru-kotsu", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
