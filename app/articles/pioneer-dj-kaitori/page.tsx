  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Pioneer DJ買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Pioneer DJ機材の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "入門DDJで5,000〜3万円、CDJ-2000NXS2で8万〜20万円、CDJ-3000は20万〜30万円以上が目安です。" } },
      { "@type": "Question", name: "コントローラー（DDJ）でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。入門〜中級コントローラーも需要があります。" } },
      { "@type": "Question", name: "セットで売ると有利ですか？", acceptedAnswer: { "@type": "Answer", text: "CDJ2台＋DJMのセットは総額が大きく、まとめ売りが有利です。" } },
      { "@type": "Question", name: "古いCDJでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "CDJ-2000無印/nexusなども需要があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Pioneer DJ買取おすすめ3社比較｜CDJ・DJMの相場と価値", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Pioneer DJ買取おすすめ3社比較｜CDJ・DJMの相場と価値", item: "https://gakkikaitori-biyori.com/articles/pioneer-dj-kaitori/" },
  ] };
  return (<>
...
export default function PioneerDjKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Pioneer DJ買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Pioneer DJ買取おすすめ3社比較｜CDJ・DJMの相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Pioneer DJの機材を売りたい方へ。CDJ-3000・CDJ-2000NXS2 などのプレーヤー、DJM-900NXS2 などのミキサー、DDJシリーズのコントローラーまで、機種・世代別の価値、状態による査定差を解説します。クラブ標準機として中古需要が非常に高いです。</p>
        ...
        <div className="article-body">
          ...
          <p>Pioneer DJの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、入門DDJで5,000〜3万円、CDJ-2000NXS2で8万〜20万円、CDJ-3000は20万〜30万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Pioneer DJを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>機種・世代（CDJ-3000・900NXS2等の新しい標準機は高評価）</li>
            <li>動作の正常性（ジョグ・端子・画面）</li>
            <li>外装・ボタン・フェーダーの状態</li>
            <li>ペア/セット販売か（総額が伸びる）</li>
            <li>純正電源・ケーブル・付属品の有無</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>Pioneer DJの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">Pioneer DJ買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Pioneer DJ機材の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">入門DDJで5,000〜3万円、CDJ-2000NXS2で8万〜20万円、CDJ-3000は20万〜30万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">コントローラー（DDJ）でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。入門〜中級コントローラーも需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">セットで売ると有利ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">CDJ2台＋DJMのセットは総額が大きく、まとめ売りが有利です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いCDJでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">CDJ-2000無印/nexusなども需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="pioneer-dj-kaitori" relatedSlugs={["dj-kizai-kaitori", "turntable-kaitori", "mixer-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
