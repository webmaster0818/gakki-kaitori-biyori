  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">マーチン D-28買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "マーチンD-28の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "現行のStandardで10万〜20万円、Reimagined/Marquis等の上位やヴィンテージリイシューで15万〜35万円、1970年代以前のヴィンテージは30万〜数百万円が目安です。戦前個体は別格です。" } },
      { "@type": "Question", name: "ハカランダ（ブラジリアンローズウッド）だと高いですか？", acceptedAnswer: { "@type": "Answer", text: "はい。ワシントン条約以前のハカランダ材を使った個体は希少で、相場が大きく上がります。" } },
      { "@type": "Question", name: "トップのクラック（割れ）があっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "売却可能です。割れ・ブレイシング剥がれは減額要因ですが、人気機種のため修復前提でも値はつきます。状態を正直に伝えましょう。" } },
      { "@type": "Question", name: "ネックリセット歴があると不利ですか？", acceptedAnswer: { "@type": "Answer", text: "適切な修理であれば致命的ではありませんが、オリジナル状態が最も高評価です。修理歴は申告しましょう。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】マーチン D-28買取相場｜年代別の価値とドレッドノートの査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】マーチン D-28買取相場｜年代別の価値とドレッドノートの査定ポイント", item: "https://gakkikaitori-biyori.com/articles/martin-d28-kaitori/" },
  ] };
  return (<>
...
export default function MartinD28KaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">マーチン D-28買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】マーチン D-28買取相場｜年代別の価値とドレッドノートの査定ポイント</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Martin D-28（マーチンD-28）を売りたい方へ。ローズウッド×スプルースのドレッドノートで、アコギの王道とも言える名機です。本記事では年代別の価値、プレウォー（戦前）個体やブレイシングの違い、トップの状態やクラックが査定に与える影響を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>マーチン D-28の買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、現行Standardで10万〜20万円、上位/リイシューで15万〜35万円、1970年代以前のヴィンテージは30万〜数百万円とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>マーチン D-28を売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>製造年（戦前プレウォーは極めて高額、各年代で評価が異なる）</li>
            <li>サイド・バックのローズウッド（ハカランダ期は特に高額）</li>
            <li>トップの割れ・ブレイシング剥がれ・ネックの状態</li>
            <li>オリジナル度（リフィニッシュ・ブリッジ交換・ネックリセット歴）</li>
            <li>純正ケース・保証書・付属品の有無</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>マーチン D-28の売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">マーチン D-28買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">マーチンD-28の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">現行のStandardで10万〜20万円、Reimagined/Marquis等の上位やヴィンテージリイシューで15万〜35万円、1970年代以前のヴィンテージは30万〜数百万円が目安です。戦前個体は別格です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ハカランダ（ブラジリアンローズウッド）だと高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。ワシントン条約以前のハカランダ材を使った個体は希少で、相場が大きく上がります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">トップのクラック（割れ）があっても売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">売却可能です。割れ・ブレイシング剥がれは減額要因ですが、人気機種のため修復前提でも値はつきます。状態を正直に伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ネックリセット歴があると不利ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">適切な修理であれば致命的ではありませんが、オリジナル状態が最も高評価です。修理歴は申告しましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="martin-d28-kaitori" relatedSlugs={["martin-kaitori", "acoustic-guitar-kaitori", "guitar-kaitori", "takaku-uru-kotsu", "souba-ichiran"]} />
      </article>
    </>
  );
}
