...
export const metadata: Metadata = {
  alternates: { canonical: 'https://gakkikaitori-biyori.com/articles/cajon-kaitori/' },
  title: "【2026年最新】カホン買取おすすめ3社比較｜相場とブランド別の価値",
  description: "カホン買取の相場とおすすめ業者3社を比較。Schlagwerk・Meinl・LP・Pepote などブランド別の価値、状態による査定差を解説。",
};
  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">カホン買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "カホンの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "量産品で1,000〜5,000円、ブランド品で3,000〜1.5万円が目安です。" } },
      { "@type": "Question", name: "打面に傷があっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "軽度なら可能ですが減額されます。" } },
      { "@type": "Question", name: "ブランド品は高いですか？", acceptedAnswer: { "@type": "Answer", text: "Schlagwerk等は中古需要があり高めです。" } },
      { "@type": "Question", name: "自作カホンでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "評価は限定的ですが状態次第です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】カホン買取おすすめ3社比較｜相場とブランド別の価値", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】カホン買取おすすめ3社比較｜相場とブランド別の価値", item: "https://gakkikaitori-biyori.com/articles/cajon-kaitori/" },
  ] };
  return (<>
...
export default function CajonKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">カホン買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】カホン買取おすすめ3社比較｜相場とブランド別の価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">カホンを売りたい方へ。Schlagwerk・Meinl・LP・Pepote などブランド別の価値、スナッピーの有無、状態による査定差を解説します。アコースティックライブで人気の打楽器です。</p>
        ...
        <div className="article-body">
          ...
          <p>カホンの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、量産品で1,000〜5,000円、ブランド品で3,000〜1.5万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>カホンを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>ブランド（Schlagwerk・Meinl等は高評価）</li>
            <li>スナッピー/ストリングの有無・タイプ</li>
            <li>打面・本体の割れ・へこみ</li>
            <li>サイズ・仕様</li>
            <li>付属品（ケース等）の有無</li>
          </ul>
          ...
          <p>カホンの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">カホンの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">量産品で1,000〜5,000円、ブランド品で3,000〜1.5万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">打面に傷があっても売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">軽度なら可能ですが減額されます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ブランド品は高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Schlagwerk等は中古需要があり高めです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">自作カホンでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">評価は限定的ですが状態次第です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="cajon-kaitori" relatedSlugs={["drum-kaitori", "souba-ichiran", "takaku-uru-kotsu", "kaitori-houhou-hikaku", "matome-uri-kaitori"]} />
      </article>
    </>
  );
}
