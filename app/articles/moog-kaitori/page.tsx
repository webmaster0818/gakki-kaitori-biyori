  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Moog買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Moogの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "小型のMother-32等で3万〜8万円、Subsequent等で10万〜25万円、ヴィンテージMinimoogは数十万〜100万円以上が目安です。" } },
      { "@type": "Question", name: "ヴィンテージMinimoogは高いですか？", acceptedAnswer: { "@type": "Answer", text: "はい。状態の良いオリジナルは非常に高額になります。" } },
      { "@type": "Question", name: "半モジュラー（Mother-32等）でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。人気が高く安定需要があります。" } },
      { "@type": "Question", name: "動作不良でも買取できますか？", acceptedAnswer: { "@type": "Answer", text: "減額されますが、ヴィンテージは修理前提でも需要があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Moog（モーグ）買取おすすめ3社比較｜アナログシンセの相場", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Moog（モーグ）買取おすすめ3社比較｜アナログシンセの相場", item: "https://gakkikaitori-biyori.com/articles/moog-kaitori/" },
  ] };
  return (<>
...
export default function MoogKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Moog買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Moog（モーグ）買取おすすめ3社比較｜アナログシンセの相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Moog（モーグ）のアナログシンセを売りたい方へ。Minimoog・Subsequent・Mother-32・Matriarch などモデル別の価値、ヴィンテージMinimoogの評価、状態による査定差を解説します。アナログシンセの名門で中古需要が高いブランドです。</p>
        ...
        <div className="article-body">
          ...
          <div className="bg-warm-bg border border-warm-border rounded-xl p-5 my-6">
            ...
            <ul className="space-y-1 text-sm list-disc pl-5">
              <li><a href="/articles/moog-subsequent37-kaitori/" className="text-accent-dark underline">モーグ サブスィークエント37の買取相場</a></li>
            </ul>
          </div>


          <h2 id="souba">買取相場の目安</h2>
          <p>Moogの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、小型Mother-32等で3万〜8万円、Subsequent等で10万〜25万円、ヴィンテージMinimoogは数十万〜100万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Moogを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>モデル（Minimoog・Subsequent・Matriarch等）</li>
            <li>ヴィンテージか現行か</li>
          ...
          <p>Moogの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Moogの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">小型のMother-32等で3万〜8万円、Subsequent等で10万〜25万円、ヴィンテージMinimoogは数十万〜100万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ヴィンテージMinimoogは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。状態の良いオリジナルは非常に高額になります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">半モジュラー（Mother-32等）でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。人気が高く安定需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">動作不良でも買取できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">減額されますが、ヴィンテージは修理前提でも需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="moog-kaitori" relatedSlugs={["synthesizer-kaitori", "keyboard-kaitori", "korg-kaitori", "roland-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
