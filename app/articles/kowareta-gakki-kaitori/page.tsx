...
function FaqSchema() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"ホーム\", \"item\": \"https://gakkikaitori-biyori.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"記事一覧\", \"item\": \"https://gakkikaitori-biyori.com/articles/\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"【2026年最新】壊れた楽器・古い楽器の買取｜ジャンク品でも売れる？相場とおすすめ業者3選\", \"item\": \"https://gakkikaitori-biyori.com/articles/kowareta-gakki-kaitori/\"}]}" }} />
    </>
  );
}
  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <RelatedArticles
          currentSlug="kowareta-gakki-kaitori"
          relatedSlugs={["kabi-gakki-kaitori", "ihin-gakki-kaitori", "tokyo-gakki-kaitori", "ochanomizu-gakki-kaitori", "osaka-gakki-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku", "piano-kaitori", "guitar-kaitori", "saxophone-kaitori", "drum-kaitori"]}
        />
      </article>
    </>
  );
