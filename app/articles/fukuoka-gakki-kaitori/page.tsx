...
function FaqSchema() {
  ...
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "【2026年9月最新】楽器買取 福岡おすすめ3選｜天神・博多エリア別に比較",
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          ...
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">
            【2026年9月最新】楽器買取 福岡おすすめ3選｜天神・博多エリア別に徹底比較
          </h1>
        ...
        <div className="article-body">
          ...
          <div className="bg-gold/10 border border-warm-border rounded-xl p-5 my-8">
            ...
            <Link href="/articles/guitar-kaitori-fukuoka/" className="text-accent font-medium text-sm hover:underline">福岡のギター買取おすすめ3社と相場を見る →</Link>
          </div>
        ...
        <RelatedArticles
          ...
          relatedSlugs={["guitar-kaitori-fukuoka", "kitakyushu-gakki-kaitori", "kumamoto-gakki-kaitori", "kagoshima-gakki-kaitori", "hiroshima-gakki-kaitori", "piano-kaitori", "guitar-kaitori", "drum-kaitori", "saxophone-kaitori", "violin-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]}
        />
      </article>
    </>
  );
