...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ジルジャンの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "入門ZBT/ZHTで1,000〜5,000円、A/A Customで3,000〜2万円、K/K Customは1万〜5万円が目安です。セットはさらに高く。" } },
      { "@type": "Question", name: "割れたシンバルでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "クラックがあると大きく減額、または買取不可です。状態を正直に伝えましょう。" } },
      { "@type": "Question", name: "セットで売ると有利ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。ライド＋クラッシュ＋ハイハットのセットは総額が伸びます。" } },
      { "@type": "Question", name: "古いKジルジャンは高いですか？", acceptedAnswer: { "@type": "Answer", text: "オールドK（イスタンブール期等）は希少で高額になることがあります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】ジルジャン（Zildjian）買取おすすめ3社比較｜シンバルの相場", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】ジルジャン（Zildjian）買取おすすめ3社比較｜シンバルの相場", item: "https://gakkikaitori-biyori.com/articles/zildjian-kaitori/" },
  ] };
  return (<>
...
export default function ZildjianKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">ジルジャン買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】ジルジャン（Zildjian）買取おすすめ3社比較｜シンバルの相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">ジルジャン（Zildjian）のシンバルを売りたい方へ。A Zildjian・K Zildjian・A Custom・K Custom などシリーズ別の価値、サイズ別の需要、まとめ売りのコツ、状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>ジルジャンの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、入門ZBT/ZHTで1,000〜5,000円、A/A Customで3,000〜2万円、K/K Customは1万〜5万円が目安、セットはさらに高評価とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>ジルジャンを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（K/K Custom等は高評価）</li>
            <li>サイズ・種類（ライド/クラッシュ/ハイハット）</li>
            <li>クラック（割れ）・キーホールの有無</li>
            <li>セット/まとめ売りか</li>
            <li>オリジナルの刻印・状態</li>
          </ul>
          ...
          <p>ジルジャンの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">ジルジャン買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ジルジャンの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">入門ZBT/ZHTで1,000〜5,000円、A/A Customで3,000〜2万円、K/K Customは1万〜5万円が目安です。セットはさらに高く。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">割れたシンバルでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">クラックがあると大きく減額、または買取不可です。状態を正直に伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。ライド＋クラッシュ＋ハイハットのセットは総額が伸びます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いKジルジャンは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">オールドK（イスタンブール期等）は希少で高額になることがあります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="zildjian-kaitori" relatedSlugs={["drum-kaitori", "pearl-kaitori", "tama-kaitori", "matome-uri-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
