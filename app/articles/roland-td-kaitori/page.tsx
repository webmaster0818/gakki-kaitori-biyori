  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Roland電子ドラム買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Roland電子ドラムの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "TD-1/TD-07で1万〜4万円、TD-17で4万〜10万円、TD-27/TD-50は10万〜30万円以上が目安です。" } },
      { "@type": "Question", name: "古いモデルでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "動作すれば需要があります。新しいモジュールほど高評価です。" } },
      { "@type": "Question", name: "パッドだけでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。ただしセットの方が総額が伸びます。" } },
      { "@type": "Question", name: "ラックは必要ですか？", acceptedAnswer: { "@type": "Answer", text: "あると有利です。なくても買取可能な場合があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Roland電子ドラム（V-Drums）買取おすすめ3社比較｜TDの相場", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Roland電子ドラム（V-Drums）買取おすすめ3社比較｜TDの相場", item: "https://gakkikaitori-biyori.com/articles/roland-td-kaitori/" },
  ] };
  return (<>
...
export default function RolandTdKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Roland電子ドラム買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Roland電子ドラム（V-Drums）買取おすすめ3社比較｜TDの相場</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Rolandの電子ドラム（V-Drums）を売りたい方へ。TD-1・TD-07・TD-17・TD-27・TD-50 などモジュール別の価値、メッシュパッド構成、世代による査定差を解説します。電子ドラムは中古需要が安定しています。</p>
        ...
        <div className="article-body">
          ...
          <p>Roland電子ドラムの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、TD-1/TD-07で1万〜4万円、TD-17で4万〜10万円、TD-27/TD-50は10万〜30万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Roland電子ドラムを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>モジュール（TD-50＞TD-27＞TD-17＞TD-07＞TD-1）</li>
            <li>パッド構成（メッシュ/ゴム）・シンバル数</li>
            <li>動作の正常性（センサー・モジュール）</li>
            <li>ラック・ハードウェアの状態</li>
          ...
          <p>Roland電子ドラムの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">Roland電子ドラム買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">Roland電子ドラムの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">TD-1/TD-07で1万〜4万円、TD-17で4万〜10万円、TD-27/TD-50は10万〜30万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いモデルでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">動作すれば需要があります。新しいモジュールほど高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">パッドだけでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能です。ただしセットの方が総額が伸びます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ラックは必要ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
        ...
        <RelatedArticles currentSlug="roland-td-kaitori" relatedSlugs={["drum-kaitori", "roland-kaitori", "denshi-piano-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
