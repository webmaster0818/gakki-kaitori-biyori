...
export const metadata: Metadata = {
  title: "【2026年最新】楽器買取 名古屋おすすめ3選｜大須・栄・名駅エリア別に比較",
  description:
    "名古屋で楽器を売るならどこがいい？名古屋対応の楽器買取おすすめ3社を徹底比較。大須・栄・名駅エリア別の特徴、出張買取・店頭買取・宅配買取の違い、高く売るコツまで解説。ギター・ピアノ・管楽器すべて対応。",
  openGraph: {
    title: "【2026年最新】楽器買取 名古屋おすすめ3選｜大須・栄・名駅エリア別に比較",
    description: "名古屋で楽器を売るなら。おすすめ買取3社の比較と高く売るコツを徹底解説。",
  },
};
...
function FaqSchema() {
  ...
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "【2026年最新】楽器買取 名古屋おすすめ3選｜大須・栄・名駅エリア別に比較",
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          ...
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">
            【2026年最新】楽器買取 名古屋おすすめ3選｜大須・栄・名駅エリア別に徹底比較
          </h1>
