...
export const metadata: Metadata = {
  alternates: { canonical: 'https://gakkikaitori-biyori.com/articles/native-instruments-kaitori/' },
  title: "【2026年最新】Native Instruments買取おすすめ3社比較｜Maschine/Komplete",
  description: "Native Instruments（NI）買取の相場とおすすめ業者3社を比較。Maschine・Komplete Kontrol・Traktor などDTM/DJ機材の価値、世代による査定差を解説。",
};
  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">Native Instruments買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "NI機材の買取相場は？", acceptedAnswer: { "@type": "Answer", text: "入門コントローラーで5,000〜2万円、Maschine/Komplete Kontrolの上位は2万〜8万円が目安です。" } },
      { "@type": "Question", name: "ライセンスはどうなりますか？", acceptedAnswer: { "@type": "Answer", text: "ソフトのライセンス移行可否を事前確認しましょう。ハード本体は買取対象です。" } },
      { "@type": "Question", name: "古い世代でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "動作すれば需要があります。" } },
      { "@type": "Question", name: "箱がないと売れませんか？", acceptedAnswer: { "@type": "Answer", text: "売却可能ですがあると有利です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】Native Instruments買取おすすめ3社比較｜Maschine/Komplete", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】Native Instruments買取おすすめ3社比較｜Maschine/Komplete", item: "https://gakkikaitori-biyori.com/articles/native-instruments-kaitori/" },
  ] };
  return (<>
...
export default function NativeInstrumentsKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">Native Instruments買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】Native Instruments買取おすすめ3社比較｜Maschine/Komplete</h1>
          <p className="text-warm-gray text-sm leading-relaxed">Native Instruments（NI）の機材を売りたい方へ。Maschine・Komplete Kontrol（S/Aシリーズ）・Traktor などDTM/DJ機材の価値、世代による評価、状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>Native Instrumentsの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、入門コントローラーで5,000〜2万円、Maschine/Komplete Kontrol上位は2万〜8万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>Native Instrumentsを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>製品（Maschine・Komplete Kontrol・Traktor）</li>
            <li>世代（MK3等、新しいほど高評価）</li>
            <li>動作の正常性・パッド/鍵盤の状態</li>
            <li>外装・端子の状態</li>
            <li>ライセンス移行の可否・付属品</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>Native Instrumentsの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">Native Instruments買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">NI機材の買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">入門コントローラーで5,000〜2万円、Maschine/Komplete Kontrolの上位は2万〜8万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ライセンスはどうなりますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ソフトのライセンス移行可否を事前確認しましょう。ハード本体は買取対象です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古い世代でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">動作すれば需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">箱がないと売れませんか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">売却可能ですがあると有利です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="native-instruments-kaitori" relatedSlugs={["dj-kizai-kaitori", "audio-interface-kaitori", "midi-keyboard-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
