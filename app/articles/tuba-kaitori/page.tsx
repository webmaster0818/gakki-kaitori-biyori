  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">チューバ買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "チューバの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "学生用で3万〜10万円、Miraphone等のプロ用は15万〜50万円以上が目安です。" } },
      { "@type": "Question", name: "大型ですが出張で売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。出張買取が便利です。搬出経路を伝えましょう。" } },
      { "@type": "Question", name: "凹みがあっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "軽度なら可能ですが減額されます。" } },
      { "@type": "Question", name: "ロータリー式は高いですか？", acceptedAnswer: { "@type": "Answer", text: "プロ用ロータリー機は高評価です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】チューバ買取おすすめ3社比較｜相場とメーカー別の価値", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】チューバ買取おすすめ3社比較｜相場とメーカー別の価値", item: "https://gakkikaitori-biyori.com/articles/tuba-kaitori/" },
  ] };
  return (<>
...
export default function TubaKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">チューバ買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】チューバ買取おすすめ3社比較｜相場とメーカー別の価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">チューバを売りたい方へ。YAMAHA・Miraphone・B&S などメーカー別の価値、B♭/C/E♭/F管の違い、大型楽器ゆえの搬出・出張買取の活用、状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>チューバの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、学生用で3万〜10万円、Miraphone等のプロ用は15万〜50万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>チューバを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>メーカー（Miraphone・B&S・Besson等は高評価）</li>
            <li>調（B♭/C/E♭/F）・ロータリー/ピストン</li>
            <li>凹み・詰まり・動作の正常性</li>
            <li>仕上げ・大きさ</li>
            <li>ケース・搬出経路（大型のため）</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>チューバの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">チューバの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">学生用で3万〜10万円、Miraphone等のプロ用は15万〜50万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">大型ですが出張で売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。出張買取が便利です。搬出経路を伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">凹みがあっても売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
            ...
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ロータリー式は高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">プロ用ロータリー機は高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="tuba-kaitori" relatedSlugs={["euphonium-kaitori", "trombone-kaitori", "trumpet-kaitori", "gakki-shucchou-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
