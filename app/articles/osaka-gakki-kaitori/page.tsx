...
export const metadata: Metadata = {
  alternates: { canonical: 'https://gakkikaitori-biyori.com/articles/osaka-gakki-kaitori/' },
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <nav className="bg-cream border border-warm-border rounded-xl p-5 mb-8">
          ...
          <ol className="space-y-1.5 text-sm text-accent list-decimal list-inside">
            ...
            <li><a href="#flow" className="hover:underline">大阪での買取の流れ</a></li>
        ...
        <div className="article-body">
          ...
          {/* 買取の流れ */}
          <h2 id="flow">大阪での楽器買取の流れ</h2>

          <p>大阪で楽器を売る場合の一般的な流れをご紹介します。梅田・難波エリアなら店頭買取も選択肢に入ります。</p>
          ...
          <div className="space-y-4 my-6">
            <div className="flex gap-4 items-start bg-white border border-warm-border rounded-xl p-4">
              ...
              <div><h3 className="font-bold text-sm mb-1">一括査定で大阪対応業者を比較</h3><p className="text-sm text-warm-gray">ヒカカク！で一括査定すれば、大阪に出張対応する業者や、宅配買取に対応する全国業者から見積もりが届きます。</p></div>
            </div>
            <div className="flex gap-4 items-start bg-white border border-warm-border rounded-xl p-4">
              ...
              <div><h3 className="font-bold text-sm mb-1">買取方法を選択</h3><p className="text-sm text-warm-gray">梅田・難波周辺なら店頭持ち込み（ティファナ）が手軽。大型楽器や住宅街なら出張買取（ウリエル）がおすすめです。</p></div>
            </div>
            <div className="flex gap-4 items-start bg-white border border-warm-border rounded-xl p-4">
              ...
              <div><h3 className="font-bold text-sm mb-1">本査定・買取成立</h3><p className="text-sm text-warm-gray">実物を確認して正式な買取額を提示。大阪市内なら即日対応可能な業者が多いです。その場で現金支払いも可能です。</p></div>
            </div>
          </div>
