  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">売る時期の見極め</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "楽器を売るベストな時期は？", acceptedAnswer: { "@type": "Answer", text: "新生活・吹奏楽が始まる春先は需要が高まりやすいです。一方で状態劣化前に早めに売るのも重要です。" } },
      { "@type": "Question", name: "新モデル発売は影響しますか？", acceptedAnswer: { "@type": "Answer", text: "旧モデルの相場が下がる傾向があるため、発売前の売却が有利なことがあります。" } },
      { "@type": "Question", name: "使わない楽器は早く売るべき？", acceptedAnswer: { "@type": "Answer", text: "はい。時間とともに状態が劣化し査定額が下がるため早めがおすすめです。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】楽器を売るベストな時期は？｜高く売れるタイミングの見極め方", datePublished: "2026-06-05", dateModified: "2026-09-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】楽器を売るベストな時期は？｜高く売れるタイミングの見極め方", item: "https://gakkikaitori-biyori.com/articles/gakki-kaitori-jiki/" },
  ] };
  return (<>
...
export default function GakkiKaitoriJikiPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">売る時期の見極め</span>
        ...
        <div className="article-body">
          ...
          <ul>
            <li>新生活・部活シーズン（春先）は需要増</li>
            <li>新モデル発売前は旧モデルが下がりやすい</li>
            <li>状態が良いうちに売る（劣化で減額）</li>
            <li>使わなくなったら早めに（型落ち・劣化前）</li>
            <li>相場が高いタイミングを一括査定で把握</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>売る時期の見極めの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">売る時期の見極め買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">楽器を売るベストな時期は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">新生活・吹奏楽が始まる春先は需要が高まりやすいです。一方で状態劣化前に早めに売るのも重要です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">新モデル発売は影響しますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">旧モデルの相場が下がる傾向があるため、発売前の売却が有利なことがあります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">使わない楽器は早く売るべき？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。時間とともに状態が劣化し査定額が下がるため早めがおすすめです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">相場はどう調べますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ヒカカク！等の一括査定で現在の相場感を把握できます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="gakki-kaitori-jiki" relatedSlugs={["takaku-uru-kotsu", "souba-ichiran", "gakki-hozon-houhou", "kaitori-houhou-hikaku", "gakki-sokujitsu-kaitori"]} />
      </article>
    </>
  );
}
