  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">スクワイヤー買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "スクワイヤーの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "現行入門で3,000〜1万円、Classic Vibeで1万〜3万円、JV/SQ等の初期日本製は5万〜十数万円以上になることもあります。" } },
      { "@type": "Question", name: "JVシリアルは高いですか？", acceptedAnswer: { "@type": "Answer", text: "はい。1982〜84年頃のJVシリアルはコレクター人気が高く高額です。" } },
      { "@type": "Question", name: "入門セットでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "売却可能ですが評価は低めです。" } },
      { "@type": "Question", name: "改造품でも買取できますか？", acceptedAnswer: { "@type": "Answer", text: "可能ですが純正からの変更は評価が下がる場合があります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】スクワイヤー（Squier）買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】スクワイヤー（Squier）買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/squier-kaitori/" },
  ] };
  return (<>
...
export default function SquierKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">スクワイヤー買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】スクワイヤー（Squier）買取おすすめ3社比較｜相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">スクワイヤー（Squier）を売りたい方へ。現行のClassic Vibe・Contemporary から、コレクター人気の日本製JV/SQシリアルまで、シリーズ・年代による価値の違い、状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>スクワイヤーの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、現行入門で3,000〜1万円、Classic Vibeで1万〜3万円、JV/SQ初期日本製は5万〜十数万円以上のこともとされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>スクワイヤーを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（Classic Vibe等の人気ライン）</li>
            <li>年代（JV/SQ等の初期日本製はプレミア）</li>
            <li>製造国</li>
          ...
          <p>スクワイヤーの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">スクワイヤー買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">スクワイヤーの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">現行入門で3,000〜1万円、Classic Vibeで1万〜3万円、JV/SQ等の初期日本製は5万〜十数万円以上になることもあります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">JVシリアルは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。1982〜84年頃のJVシリアルはコレクター人気が高く高額です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">入門セットでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">売却可能ですが評価は低めです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">改造품でも買取できますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">可能ですが純正からの変更は評価が下がる場合があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="squier-kaitori" relatedSlugs={["fender-kaitori", "guitar-kaitori", "fender-stratocaster-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
