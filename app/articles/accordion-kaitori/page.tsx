  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">アコーディオン買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "アコーディオンの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "量産入門で5,000〜2万円、中級で2万〜10万円、イタリア製高級は10万〜数十万円が目安です。" } },
      { "@type": "Question", name: "蛇腹に破れがあっても売れますか？", acceptedAnswer: { "@type": "Answer", text: "軽度なら買取可能ですが、気密が損なわれると減額されます。状態を正直に伝えましょう。" } },
      { "@type": "Question", name: "古いアコーディオンでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "ヴィンテージのイタリア製などは需要があります。" } },
      { "@type": "Question", name: "ボタン式でも買取対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。クロマチックボタン式も買取対象です。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】アコーディオン買取おすすめ3社比較｜相場とメーカー別の価値", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】アコーディオン買取おすすめ3社比較｜相場とメーカー別の価値", item: "https://gakkikaitori-biyori.com/articles/accordion-kaitori/" },
  ] };
  return (<>
...
export default function AccordionKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">アコーディオン買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】アコーディオン買取おすすめ3社比較｜相場とメーカー別の価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">アコーディオンを売りたい方へ。TOMBO・Hohner・Excelsior などメーカー別の価値、鍵盤式/クロマチックボタン式の違い、リードや蛇腹の状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>アコーディオンの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、量産入門で5,000〜2万円、中級で2万〜10万円、イタリア製高級は10万〜数十万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>アコーディオンを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>メーカー（イタリア製Excelsior・Hohner等は高評価）</li>
            <li>鍵盤式/ボタン式・ベース数</li>
            <li>蛇腹（ジャバラ）の気密・破れの有無</li>
            <li>リードの状態・音程</li>
            <li>ケース・ストラップなど付属品</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>アコーディオンの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">アコーディオン買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">アコーディオンの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">量産入門で5,000〜2万円、中級で2万〜10万円、イタリア製高級は10万〜数十万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">蛇腹に破れがあっても売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">軽度なら買取可能ですが、気密が損なわれると減額されます。状態を正直に伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いアコーディオンでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">ヴィンテージのイタリア製などは需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ボタン式でも買取対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。クロマチックボタン式も買取対象です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="accordion-kaitori" relatedSlugs={["souba-ichiran", "takaku-uru-kotsu", "kaitori-houhou-hikaku", "piano-kaitori", "keyboard-kaitori"]} />
      </article>
    </>
  );
}
