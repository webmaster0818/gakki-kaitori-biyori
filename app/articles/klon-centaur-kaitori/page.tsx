  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">クロン ケンタウルス買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "クロン ケンタウルスの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "希少性が非常に高く、状態や個体差にもよりますが中古市場では数十万円規模で取引されることがあります。正確な額は無料査定でご確認ください。" } },
      { "@type": "Question", name: "KTR（クロンKTR）との違いは？", acceptedAnswer: { "@type": "Answer", text: "KTRは後継の現行モデルで、オリジナルのCentaurとは別評価です。Centaurの方が希少で高額になります。" } },
      { "@type": "Question", name: "金パネルと銀パネルで違いはありますか？", acceptedAnswer: { "@type": "Answer", text: "仕様・年代の指標として個体差があり、コレクター需要に影響します。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】クロン ケンタウルス買取相場｜希少オーバードライブの価値と査定ポイント", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】クロン ケンタウルス買取相場｜希少オーバードライブの価値と査定ポイント", item: "https://gakkikaitori-biyori.com/articles/klon-centaur-kaitori/" },
  ] };
  return (<>
...
export default function KlonCentaurKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">クロン ケンタウルス買取</span>
        ...
        <div className="article-body">
          ...
          <p>クロン ケンタウルスの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、希少性が非常に高く、状態・個体差により中古市場で数十万円規模で取引されることもとされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>クロン ケンタウルスを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>個体差（金パネル/銀パネル、ロングテール等の仕様・年代）</li>
            <li>オリジナルであること（後継のKTRや各種クローンとは別評価）</li>
            <li>動作確認（ノイズ・ガリ・スイッチ）</li>
            <li>外装の状態・ノブ・付属品</li>
            <li>改造の有無（オリジナル基板が高評価）</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>クロン ケンタウルスの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">クロン ケンタウルス買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">クロン ケンタウルスの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">希少性が非常に高く、状態や個体差にもよりますが中古市場では数十万円規模で取引されることがあります。正確な額は無料査定でご確認ください。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">KTR（クロンKTR）との違いは？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">KTRは後継の現行モデルで、オリジナルのCentaurとは別評価です。Centaurの方が希少で高額になります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">金パネルと銀パネルで違いはありますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">仕様・年代の指標として個体差があり、コレクター需要に影響します。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">クローン（コピー品）でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">各社クローンは別評価です。オリジナルのKlon Centaurであるかが価格を大きく左右します。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="klon-centaur-kaitori" relatedSlugs={["effector-kaitori", "ibanez-ts808-kaitori", "takaku-uru-kotsu", "souba-ichiran", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
