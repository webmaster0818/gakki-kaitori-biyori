  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">カリンバ買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "カリンバの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "量産入門で数百〜2,000円、Hugh Tracey等の本格機で3,000〜1万円が目安です。" } },
      { "@type": "Question", name: "入門カリンバでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "低額ですが状態次第で値がつきます。" } },
      { "@type": "Question", name: "本格ブランドは高いですか？", acceptedAnswer: { "@type": "Answer", text: "Hugh Tracey等は需要があり高めです。" } },
      { "@type": "Question", name: "まとめ売りは有利ですか？", acceptedAnswer: { "@type": "Answer", text: "複数あれば総額が伸びます。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社はすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】カリンバ買取おすすめ3社比較｜相場とブランド別の価値", datePublished: "2026-06-05", dateModified: "2026-07-07", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】カリンバ買取おすすめ3社比較｜相場とブランド別の価値", item: "https://gakkikaitori-biyori.com/articles/kalimba-kaitori/" },
  ] };
  return (<>
...
export default function KalimbaKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">カリンバ買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】カリンバ買取おすすめ3社比較｜相場とブランド別の価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">カリンバ（親指ピアノ）を売りたい方へ。GECKO・Hugh Tracey などブランド別の価値、17キー/21キー等のキー数、板/箱型の違い、状態による査定差を解説します。</p>
        ...
        <div className="article-body">
          ...
          <p>カリンバの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、量産入門で数百〜2,000円、Hugh Tracey等の本格機で3,000〜1万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>カリンバを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>ブランド（Hugh Tracey等の本格機は高評価）</li>
            <li>キー数（17/21キー等）・板型/箱型</li>
            <li>材（無垢/合板）と状態</li>
            <li>チューニングの安定・キーの状態</li>
            <li>ケース・付属品の有無</li>
          </ul>
          ...
          <p>カリンバの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">カリンバの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">量産入門で数百〜2,000円、Hugh Tracey等の本格機で3,000〜1万円が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">入門カリンバでも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">低額ですが状態次第で値がつきます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">本格ブランドは高いですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Hugh Tracey等は需要があり高めです。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">複数あれば総額が伸びます。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="kalimba-kaitori" relatedSlugs={["souba-ichiran", "takaku-uru-kotsu", "kaitori-houhou-hikaku", "harmonica-kaitori", "matome-uri-kaitori"]} />
      </article>
    </>
  );
}
