  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">DW買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "DWの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "Designシリーズで3万〜10万円、Performanceで8万〜20万円、Collector'sは15万〜40万円以上が目安です。" } },
      { "@type": "Question", name: "ペダル単体でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。DW5000/9000ペダルは単体でも人気で需要があります。" } },
      { "@type": "Question", name: "スネア単体は評価されますか？", acceptedAnswer: { "@type": "Answer", text: "Collector'sのスネアは単体でも高評価です。" } },
  ...
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】DW（ドラムワークショップ）買取おすすめ3社比較｜相場と価値", datePublished: "2026-06-05", dateModified: "2026-06-05", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】DW（ドラムワークショップ）買取おすすめ3社比較｜相場と価値", item: "https://gakkikaitori-biyori.com/articles/dw-kaitori/" },
  ] };
  return (<>
...
export default function DwKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">DW買取</span>
        ...
        <div className="article-body">
          ...
          <p>DWの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、Designで3万〜10万円、Performanceで8万〜20万円、Collector'sは15万〜40万円以上が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>DWを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>シリーズ（Collector's＞Performance＞Design）</li>
            <li>構成（バスドラ・タム・スネアのセット内容）</li>
            <li>シェル材・フィニッシュと状態</li>
            <li>ハードウェア・ペダルの動作</li>
            <li>純正パーツ・付属品の有無</li>
          </ul>
          ...
          <p>DWの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">DWの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Designシリーズで3万〜10万円、Performanceで8万〜20万円、Collector'sは15万〜40万円以上が目安です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">ペダル単体でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。DW5000/9000ペダルは単体でも人気で需要があります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">スネア単体は評価されますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">Collector'sのスネアは単体でも高評価です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">フルセットは総額が大きく、まとめ売りが有利です。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="dw-kaitori" relatedSlugs={["drum-kaitori", "pearl-kaitori", "tama-kaitori", "zildjian-kaitori", "souba-ichiran"]} />
      </article>
    </>
  );
}
