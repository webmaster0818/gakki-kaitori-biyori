  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">グランドピアノ買取</span></li>
      </ol>
    </nav>
  );
}
...
function CtaBox() {
  return (
    <div className="bg-cream border border-warm-border rounded-2xl p-6 my-8">
      <p className="font-bold text-base mb-4 text-center text-accent-dark">グランドピアノの買取価格を無料で確認</p>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <nav className="bg-cream border border-warm-border rounded-xl p-5 mb-8">
          ...
          <ol className="space-y-1.5 text-sm text-accent list-decimal list-inside">
            <li><a href="#summary" className="hover:underline">1. グランドピアノの特徴と市場概況</a></li>
        ...
        <p>2026年5月現在、グランドピアノの買取相場は、入門モデルで100,000円〜、中級モデルで約1,000,000円前後、プロ仕様の上位モデルは15,000,000円までと幅広い価格帯になります。</p>
        ...
        <p>グランドピアノは、メーカー・モデルによって買取相場が大きく異なります。代表的なブランドの相場目安は以下の通りです。</p>
        ...
        <ol>
          ...
          <li><strong>専門業者を選ぶ</strong>: ピアノに強い買取業者なら、適正価格で査定してくれる</li>
        </ol>

        <h2 id="appraisal">グランドピアノの真贋・査定のポイント</h2>
        <p>グランドピアノは高額品ほど贋作・コピー品が市場に流通しています。買取査定では以下の点が重視されます:</p>
        <ul>
        ...
        <p>不安な場合は、グランドピアノの専門知識を持つ買取業者で鑑定査定を依頼しましょう。</p>

        <h2 id="partner">6. おすすめ買取業者3社</h2>
        <p>グランドピアノの買取で実績のある3社を紹介します。それぞれ強みが異なるため、自分の状況に合わせて選ぶのがおすすめです。</p>
        <ul>
        ...
        <p>まずは無料査定で、おおよそのグランドピアノの買取価格を確認してみましょう。</p>
