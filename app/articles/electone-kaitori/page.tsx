...
export const metadata: Metadata = {
  alternates: { canonical: 'https://gakkikaitori-biyori.com/articles/electone-kaitori/' },
  title: "【2026年最新】エレクトーン買取おすすめ3社比較｜YAMAHA STAGEAの相場と価値",
  description: "エレクトーン（YAMAHA STAGEA等）買取の相場とおすすめ業者3社を比較。ELS-02/ELC機種別の価値、設置・搬出の注意点、状態による査定差を解説。",
};
  ...
  return (
    <nav aria-label="パンくずリスト" className="max-w-4xl mx-auto px-4 py-3">
      <ol className="flex flex-wrap items-center text-xs text-warm-gray">
        ...
        <li className="flex items-center"><span className="breadcrumb-sep" /><span className="text-foreground font-medium">エレクトーン買取</span></li>
      </ol>
    </nav>
  );
}
...
function FaqSchema() {
  const faqData = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "エレクトーンの買取相場は？", acceptedAnswer: { "@type": "Answer", text: "旧機種(EL系)は数千〜数万円、STAGEA ELS-02系は年式・状態により数万〜十数万円が目安です。正確な額は無料査定でご確認ください。" } },
      { "@type": "Question", name: "古いEL機種でも売れますか？", acceptedAnswer: { "@type": "Answer", text: "動作すれば買取可能な場合がありますが、評価は低めです。状態次第で引き取りのみの場合もあります。" } },
      { "@type": "Question", name: "搬出はしてもらえますか？", acceptedAnswer: { "@type": "Answer", text: "出張買取に対応する業者なら搬出込みで対応してくれる場合があります。大型のため事前に経路を伝えましょう。" } },
      { "@type": "Question", name: "椅子や譜面台も査定対象ですか？", acceptedAnswer: { "@type": "Answer", text: "はい。付属品が揃っていると査定額が上がります。" } },
      { "@type": "Question", name: "費用はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "掲載3社は査定・出張・送料・キャンセルすべて無料です。" } }
  ] };
  const articleData = { "@context": "https://schema.org", "@type": "Article", headline: "【2026年最新】エレクトーン買取おすすめ3社比較｜YAMAHA STAGEAの相場と価値", datePublished: "2026-06-05", dateModified: "2026-08-01", author: { "@type": "Organization", name: "楽器買取びより" }, publisher: { "@type": "Organization", name: "楽器買取びより" } };
  const crumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "【2026年最新】エレクトーン買取おすすめ3社比較｜YAMAHA STAGEAの相場と価値", item: "https://gakkikaitori-biyori.com/articles/electone-kaitori/" },
  ] };
  return (<>
...
export default function ElectoneKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <Breadcrumb />
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-gold/10 text-gold-dark text-xs font-bold px-3 py-1 rounded-full">エレクトーン買取</span>
            <span className="bg-accent/10 text-accent text-xs font-bold px-3 py-1 rounded-full">2026年最新</span>
          </div>
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">【2026年最新】エレクトーン買取おすすめ3社比較｜YAMAHA STAGEAの相場と価値</h1>
          <p className="text-warm-gray text-sm leading-relaxed">エレクトーン（YAMAHA STAGEA等）を売りたい方へ。ELS-02・ELC-02 などの機種別の価値、年式による評価、搬出・設置の注意点、高く売るコツを解説します。エレクトーンはYAMAHAの独自製品で、機種と年式が価格を左右します。</p>
        ...
        <div className="article-body">
          ...
          <p>エレクトーンの買取相場は、ブランド・モデル・状態によって大きく変わります。あくまで目安として、旧EL機種で数千〜数万円、STAGEA ELS-02系は年式・状態で数万〜十数万円が目安とされています。正確な査定額は楽器の状態や付属品、時期によって変動するため、無料査定で確認するのが確実です。</p>
          <p className="text-xs text-warm-gray">※相場は一般的な中古市場の目安であり、実際の買取額を保証するものではありません。</p>

          <h2 id="points">査定額を左右するポイント</h2>
          <p>エレクトーンを売る際、以下のポイントが査定額に影響します。売却前にチェックしておきましょう。</p>
          <ul>
            <li>機種（STAGEA ELS-02/ELS-02C/ELC-02等）と年式</li>
            <li>動作の正常性（鍵盤・音源・データ周り）</li>
            <li>外装の傷・日焼け</li>
            <li>付属品（譜面台・椅子・電源・USB等）</li>
            <li>搬出経路（大型のため搬出条件も影響）</li>
          </ul>

          <CtaBox />

          <h2 id="osusume">おすすめ買取サービス3社</h2>
          <p>エレクトーンの売却には、以下の3サービスの活用がおすすめです。いずれも査定料・送料・キャンセル料が無料です。</p>
          <ul>
          ...
          <h2 id="faq">エレクトーン買取に関するよくある質問</h2>
          <div className="space-y-4 mt-6">
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">エレクトーンの買取相場は？</span>
              ...
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">旧機種(EL系)は数千〜数万円、STAGEA ELS-02系は年式・状態により数万〜十数万円が目安です。正確な額は無料査定でご確認ください。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">古いEL機種でも売れますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">動作すれば買取可能な場合がありますが、評価は低めです。状態次第で引き取りのみの場合もあります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">搬出はしてもらえますか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">出張買取に対応する業者なら搬出込みで対応してくれる場合があります。大型のため事前に経路を伝えましょう。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
                <span className="pr-4">椅子や譜面台も査定対象ですか？</span>
                <svg className="w-5 h-5 text-warm-gray shrink-0 faq-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="px-5 pb-4 text-sm text-warm-gray leading-relaxed">はい。付属品が揃っていると査定額が上がります。</div>
            </details>
            <details className="bg-white rounded-xl border border-warm-border overflow-hidden">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-bold">
        ...
        <RelatedArticles currentSlug="electone-kaitori" relatedSlugs={["piano-kaitori", "denshi-piano-kaitori", "yamaha-kaitori", "souba-ichiran", "takaku-uru-kotsu"]} />
      </article>
    </>
  );
}
