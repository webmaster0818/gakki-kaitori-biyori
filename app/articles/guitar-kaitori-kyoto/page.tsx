...
export const metadata: Metadata = {
  ...
  title: "京都のギター買取おすすめ3社を比較【2026年9月】高く売るコツと相場",
...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"京都のギター買取おすすめ3社を比較【2026年9月】高く売るコツと相場\", \"datePublished\": \"2026-07-04\", \"dateModified\": \"2026-07-04\", \"author\": {\"@type\": \"Organization\", \"name\": \"楽器買取びより\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"楽器買取びより\"}}" }} />
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        <header className="mb-8">
          ...
          <h1 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-4">
            京都のギター買取おすすめ3社を比較【2026年9月】高く売るコツと相場
          </h1>
