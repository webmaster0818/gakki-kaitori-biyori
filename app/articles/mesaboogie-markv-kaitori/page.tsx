  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <RelatedArticles currentSlug="mesaboogie-markv-kaitori" relatedSlugs={["guitar-amp-kaitori", "guitar-amp-kaitori", "souba-ranking", "takaku-uru-kotsu", "kaitori-houhou-hikaku"]} />
      </article>
    </>
  );
}
